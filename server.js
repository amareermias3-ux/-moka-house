/* ================================================================
   MOKA HOUSE — v5.5 (Supabase persistent DB + everything)
================================================================ */
...
/* 🗄️ Supabase (optional persistent storage) */
...
am:{board:'ሜኑው',brew:'ማፍያ ላብ',shops:'ሱቆች',club:'ስታምፕ ካርድ',events:'ዝግጅቶች',staff:'ሠራተኛ ⚿',tray:'መሸጫ',mast_copy:'ትንሽ-ርቢ ቡና፣ ማክሰኞ ሁ በኋለው ክፍል የተጠበ እና በሦስት ካውንተሮች ቀኑን ሙሉ የሚፍ።',cta1:'ሜኑውን ር ↓',cta2:'ኩፒንግ ያዝ',roast:'ዛሬ በባር ላይ →',open_closes:'ክፍት · ይጋል',closed_opens:'ዝግ · ይከታል',closed_day:'ዛሬ ግ ነው',s1_title:'ዛሬ <em>ምን አለ</em>',s1_desc:'ሁሉም በቤት ውስጥ የተዘጋጀ። ወ መሸጫ ጨምረህ በምትፈልው ዘ ክፈል።',add:'+ ጨምር',soldout:'አልቋል',cat_all:'ሁሉም',cat_espresso:'ኤስረ',cat_filter:'ፊልተር',cat_cold:'ቀዝቃዛ',cat_bakes:'ኬኮች',s2_title:'በቤት <em>አዘጋ</em>',s2_desc:'የባር ስነ-ህጎቻችን በቀጥታ። ዘዴ ምረ እና ከታይመር ጋር አዘጋ።',dose:'መጠን',ratio:'ሬሾ',water:'ውሃ',temp:'የውሃ ሙቀት',grind:'ፍጭት',timer:'ማፍያ ታይመር',start:'ማፍያ ጀምር ▸',s3_title:'ሦስት ክፍሎች፣ <em>አንድ ጥበስ</em>',s3_desc:'ቀጥ የበር ሁኔታ፣ ከዓቱ።',s4_title:'ሰብ ዛ <em>ስምንተኛው በእኛ</em>',s4_desc:'በእያንዳንዱ መጠጥ አንድ ስታምፕ — ካርድህ ስታውስሃል።',p1:'ካርዱ ሞላ ማንኛውም መጠን ነፃ መጠጥ',p2:'የእያንዳንዱ አዲስ ጥበስ የመጀመሪያ ቅዳ ለአባላት',p3:'በቡና ፍሬዎች 10% ቅናሽ፣ ሁልጊዜ',p4:'በአርብ ኩፒንጎች የመቀመ ቅድያ',collect:'የዛሬን ስታምፕ ሰብስብ',s5_title:'ክፍለ-ጊዜዎች እና <em>ስነ-ጣዕም</em>',s5_desc:'መቀመጫዎች ውስን ናቸው — ያዙ።',seats:'መቀመጫዎች ቀርተል',reserve:'መቀመጫ ያዙ',s6_title:'ዜና እና <em>ታሪኮች</em>',s6_desc:'የምናጠሰው እና የምንቀዳው — በሠራተኞች የተለጠ።',hello_title:'ሰላም በል — <b>መልካም ነገር</b> እንቀዳልሃለን።',news_btn:'ወደ ዝርዝ ተቀቀል',f_visit:'ጎብ',f_hours:'ዓታት',f_elsewhere:'ሌላም',empty_tray:'መሸጫህ ዶ ነው',pickup:'መውሰጃ',subtotal:'ንዑስ ድምር',checkout:'ክፍያ ◆',pay_method:'የመክፈያ ዴ ምረጥ',confirm:'ክፍያውን አረጋግጥ',processing:'በሂደት ላይ...',cancel:'ይቅር',success:'ክፍያው ተሳክቷል!',order_no:'ትዕዛዝ',chat_greet:'ሰላም! ☕ ስለ ሜኑ፣ ዋጋ ሰዓት፣ ዝጅት ወይም ማያ የፈለግክህን ጠይቅ።',chat_ph:'የፈለግክህን ጠይቅ…',bot_menu:'በሜኑ ይ',bot_price:'ዋጋው',bot_hours:'ክፍት እንሆናለን',bot_loc:'የምንገኝበት',bot_pay:'የምንቀበላቸው',bot_stamp:'ስታምፕ ካርድ፦ 7 ግዛ 8ው ነ።',bot_events:'የሚመጡ ዝግጅቶች',bot_brew:'የማፍያ መመሪያ',bot_langs:'ሳይ የሚናገራቸው',bot_credit:'ይህ ፕሮጀክት የተሰራው በ',bot_fallback:'ሜኑን፣ ዋን፣ ሰዓትን፣ ዝጅቶችን፣ ክፍያችን እና ማፍያን አውቃለሁ — ሞክረኝ!',back_shop:'← ወደ ቁ ተመለስ',login:'ግባ',register:'ተመዝገብ',logout:'ውጣ'},
...
ti:{board:'ሜኑ',brew:'ላብ ን',shops:'ዱናት',club:'ርዲ',events:'መደባት',staff:'ሰራሕተኛ ⚿',tray:'መሸጢ',mast_copy:'ንእሽቶ ምላ ቡን ሰሉስ ጠ ብሰለስተ ቦታ መዓልቲ ምሉእ ይስራብ።',cta1:'ሜኑ ርአ ↓',cta2:'ምስትምቓር ሓዝ',roast:'ሎሚ ኣብ ር →',open_closes:'ክፉት · ዕጾ',closed_opens:'ዕጹው · ክፈት',closed_day:'ሎሚ ዕጹው',s1_title:'ሎሚ <em>እንታይ ኣሎ</em>',s1_desc:'ኩሉ ብ ውሽጢ ይሎ ናብ መሸጢኻ ወስኽ።',add:'+ ወስኽ',soldout:'ወዲኡ',cat_all:'ኩሉ',cat_espresso:'ኤስረሶ',cat_filter:'ፊልተር',cat_cold:'ዝሑል',cat_bakes:'ዳቦ',s2_title:'ኣብ ዛ <em>ዳሎ</em>',s2_desc:'ሕታት ባርና። መገዲ ሓኻ ስ ታይመር ዳሎ።',dose:'መጠን',ratio:'ሬሾ',water:'ማይ',temp:'ሙቐት ማይ',grind:'ጥሕነት',timer:'ታይመር',start:'ጀምር ▸',s3_title:'ሰለስተ ክፍሊ፡ <em>ሓንቲ ጥሲ</em>',s3_desc:'ኩነታት ብቐጥታ።',s4_title:'ሸውዓተ ግዛእ፡ <em>8ይ ብናትና</em>',s4_desc:'ንነፍሲ ከፍ መስተ ሓንቲ ስምፕ',p1:'ካርዲ ምስ መልአ ነጻ መስተ',p2:'ቀዳማይ ቲ ንባላት',p3:'ኣብ ቡን 10% ርካሽ',p4:'ቀምነት መቐመጢ ዓርቢ',collect:'ስታምፕ ሎሚ',s5_title:'ክፍለ ግዜን <em>ምስትምቓርን</em>',s5_desc:'መቐመጢ ውሱን — ሓዝ።',seats:'መቐመጢ ተሪፉ',reserve:'መቐመጢ ሓዝ',s6_title:'ዜናን <em>ታሪን</em>',s6_desc:'እንጠብቖ — ሰራሕተኛት።',hello_title:'ሰላም በል — <b>ጽቡቕ</b> ከስትየካ።',news_btn:'ናብ ዝርዝር ጽምበር',f_visit:'በጽሕ',f_hours:'ሰዓታት',f_elsewhere:'ካልእ',empty_tray:'መሸጢኻ ባዕል እዩ።',pickup:'ምውሳድ',subtotal:'ንኡስ ድምር',checkout:'ክፈል ◆',pay_method:'መገዲ ክፍሊት ምረጽ',confirm:'ኣረጋግጽ',processing:'ይስራሕ...',cancel:'ሰርዝ',success:'ክፍሊት ዓዊቱ!',order_no:'ትእዛዝ',chat_greet:'ሰላም! ☕ ብዛዕባ ሜኑ ዋ፡ ሰዓት፡ መባት ተት',chat_ph:'ዝለኻዮ ሕተት…',bot_menu:'ኣብ ኑ',bot_price:'ዋጋ',bot_hours:'ፉታት ና',bot_loc:'ትረኽበና',bot_pay:'ንቕበሎም',bot_stamp:'ካርዲ፡ 7 ግዛእ 8ይ ነጻ።',bot_events:'መጽእ መደባት',bot_brew:'መምርሒ ዳሎ',bot_langs:'እቲ ሳይት ዛረበን',bot_credit:'እዚ ፕሮጀክት ብ',bot_fallback:'ሜኑ ዋ፡ ዓት መደባት፡ ክሊት እፈል — ፈትን!',back_shop:'← ናብ ዱን',login:'እቶ',register:'ተመዝገብ',logout:'ውጻእ'},
...
am:{register:'መለያ ለመፍጠር፦ Register ጽ ይ ስም፣ ኢሜይል፣ ስል እና የይለ ቃል ላ — ወይም "በGoogle ተመዝገ"',login:'በተቃሚ ም ወይም ሜይል + የይለፍ ቃል ግባ — ወይም በGoogle።',wallet:'ቴሌ ር፣ ም-ፔሳ፣ PayPal ካርድ ባንክ እና ክሪፕቶ እንቀበላለን።',stamps:'ስታምፕ ካርድ፦ በእያንዳንዱ መጠጥ አንድ ስታም — 7 ገዝተህ 8ው ነ።',new:'አዲስ ዜና ',langs:'ይቱ በ8 ንቋዎች ይናገራል — ከላይ ኝ መቀየር ትችላለህ።',delivery:'እስካሁን አናደርስም — በሦስቱም ሱቆቻችን ተረብ።'},
...
ti:{register:'ሕሳብ ንምፍጣር ኣ Register ስም፡ ኢመይል፡ ስልክን ፓስዎርድን መላእ — ወይ ብGoogle።',login:'ብስም ይ ኢመይል + ፓስዎርድ እቶ፡ ወይ ብGoogle።',wallet:'Telebirr, M-Pesa, PayPal, ካርድ, ባንክን ክሪቶን ቕበል',stamps:'ካርዲ፡ ንነፍሲወከፍ መስተ ሓንቲ ስታም — 7 ግዛእ 8ይ ነጻ።',new:'ሓድሽ ዜና፦ ',langs:'እቲ ሳይት 8 ቋንቋታት ይዛረ — ካብ ላዕሊ ቀያይር።',delivery:'ኣየብጽሕን — ኣብ ሰለስተ ዱኳናትና ተቐበል።'},
...
/* wait for DB hydration before any route */
