/* ================================================================
   MOKA HOUSE — v5.1 (ሙ ትርጉም 82×8 + ብልጥ AI Bot)
================================================================ */
...
am:{board:'ሜኑው',brew:'ማፍያ ላብ',shops:'ሱቆች',club:'ስታምፕ ካርድ',events:'ዝግጅቶች',staff:'ሠራተኛ ⚿',tray:'መሸጫ',mast_copy:'ትንሽ-ርቲ ቡና፣ ማክኞ ሁሉ በኋለኛው ክፍል የተጠበሰ እና በሦስት ካውንተሮች ቀኑን ሙሉ የሚቀ።',cta1:'ሜኑውን ር ↓',cta2:'ኩፒንግ ያዝ',roast:'ዛሬ በባር ላይ →',open_closes:'ክፍት · ይጋል',closed_opens:'ዝግ · ይከታል',closed_day:'ዛሬ ግ ነው',s1_title:'ዛሬ <em>ምን አለ</em>',s1_desc:'ሁሉም በቤት ውስጥ የተዘጋጀ። ወደ መሸጫ ጨምህ በምትፈልገው ዘዴ ክል።',add:'+ ጨምር',soldout:'አልቋል',cat_all:'ሁሉም',cat_espresso:'ኤስረሶ',cat_filter:'ፊልተር',cat_cold:'ቀዝቃዛ',cat_bakes:'ኬኮች',s2_title:'በቤት <em>አዘጋጅ</em>',s2_desc:'የባር ስነ-ህጎቻችን በቀጥታ። ዘዴ ምረ እና ከታይመሩ ጋር አዘጋጅ',dose:'መጠን',ratio:'ኑ',water:'ውሃ',temp:'የውሃ ሙቀት',grind:'ፍጭት',timer:'ማፍያ ታይመር',start:'ማፍያ ጀምር ▸',s3_title:'ሦስት ክፍሎች፣ <em>አንድ ጥበስ</em>',s3_desc:'ቀጥታ የበር ሁኔታ፣ ከሰዓ።',s4_title:'ሰብ ግዛ፣ <em>ስምንተኛው በእኛ</em>',s4_desc:'በእያንዳንዱ መጠ አንድ ታምፕ — ካርድህ ስታውስሃል።',p1:'ካርዱ ሲሞላ ማንኛውም መጠን ፃ መጠጥ',p2:'የእያንዳንዱ አዲስ ጥበስ የመጀመሪያ ቅዳ ለአባላት',p3:'በቡና ፍሬች 10% ቅናሽ ሁልዜ',p4:'በአርብ ኩፒንጎች የመቀመጫ ቅድሚያ',collect:'የዛሬን ስታም ሰብስብ',s5_title:'ክፍለ-ጊዜች እና <em>ስነ-ጣዕም</em>',s5_desc:'መቀመጫዎች ውስን ናቸው — ያ።',seats:'መቀመጫዎች ቀርተዋል',reserve:'መቀመጫ ያዝ',s6_title:'ዜና እና <em>ታሪኮች</em>',s6_desc:'የምናጠብሰው እና የምንቀዳው — በሠራተኞች የተለጠፈ።',hello_title:'ሰላም በል — <b>መልካም ነገር</b> እንቀዳልሃለን።',news_btn:'ወደ ርዝሩ ቀላል',f_visit:'ጎብኝ',f_hours:'ሰዓታት',f_elsewhere:'ሌላም',empty_tray:'መሸጫ ባዶ ነው።',pickup:'መውሰጃ',subtotal:'ንዑስ ድምር',checkout:'ክፍያ ◆',pay_method:'የመክፈያ ዘዴ ምረ',confirm:'ፍያውን አረጋግጥ',processing:'በሂደት ላይ...',cancel:'ይቅር',success:'ክፍያው ተሳክቷል!',order_no:'ትዕዛ',chat_greet:'ላም! ☕ ለ ሜኑ፣ ዋ፣ ዓት፣ ዝግጅት ወይም ማፍያ የፈለግክህን ጠይቅ።',chat_ph:'የፈለክህን ይቅ…',bot_menu:'በሜኑ ላይ',bot_price:'ዋጋው',bot_hours:'ክፍት እንሆናለን',bot_loc:'የምንገኝበት',bot_pay:'የምንቀበላቸው',bot_stamp:'ስታምፕ ካርድ፦ 7 ግዛ፣ 8ው ነ።',bot_events:'የሚመጡ ዝግጅቶች',bot_brew:'የማፍያ መመሪያ',bot_langs:'ሳይቱ የሚናገራቸው',bot_credit:'ይህ ፕሮክት የተሰራው በ',bot_fallback:'ሜኑን፣ ዋጋን፣ ሰዓትን፣ ዝጅቶችን፣ ክፍያዎችን እና ማፍያን አውቃለሁ — ሞክር!',back_shop:'← ወደ ቁ ተመለስ',login:'ግ',register:'ተመዝገብ',logout:'ውጣ'},
...
ti:{board:'ሜኑ',brew:'ላብ ን',shops:'ኳናት',club:'ካርዲ',events:'መደባት',staff:'ሰራሕተኛ ⚿',tray:'መሸጢ',mast_copy:'ንእሽቶ ጉጅለ ቡን፡ ሰሉስ ጠቢቡ ብለስተ ቦታ መዓልቲ ሉእ ይርብ።',cta1:'ሜኑ ርአ ↓',cta2:'ምስትምቓር ሓዝ',roast:'ሎ ኣብ ር →',open_closes:'ክት · ዕጾ',closed_opens:'ዕጹው · ክፈት',closed_day:'ሎሚ ዕጹው',s1_title:'ሎሚ <em>እንታይ ኣሎ</em>',s1_desc:'ኩ ኣብ ሽጢ ይዳ። ናብ መሸጢኻ ወስኽ።',add:'+ ወስኽ',soldout:'ወኡ',cat_all:'ኩ',cat_espresso:'ስፕሶ',cat_filter:'ፊልተር',cat_cold:'ዝል',cat_bakes:'ዳቦ',s2_title:'ኣ ገዛ <em>ዳ</em>',s2_desc:'ሕግታት ባርና። መገዲ ረ ምስ ይመር ዳሎ።',dose:'መጠን',ratio:'ሬሾ',water:'ማይ',temp:'ሙቐት ማይ',grind:'ጥሕነት',timer:'ታይመር',start:'ጀምር ▸',s3_title:'ሰለስተ ክፍሊ፡ <em>ሓንቲ ጥብሲ</em>',s3_desc:'ኩነታት ብቐጥታ።',s4_title:'ሸውዓተ ግእ፡ <em>8ይ ብናትና</em>',s4_desc:'ንነፍሲ ወከፍ ስትምፓ።',p1:'ካርዲ ምስ መልአ ነጻ ስተ',p2:'ቀማይ ስቲ ንኣላት',p3:'ኣብ ቡን 10% ርካሽ',p4:'ቀዳምነት መቐመጢ ዓርቢ',collect:'ስትምፓ ሎሚ',s5_title:'ክለ ግዜን <em>ምስትምቓርን</em>',s5_desc:'መቐመጢ ውሱን — ሓዝ።',seats:'መቐመጢ ተሪፉ',reserve:'መቐመጢ ሓዝ',s6_title:'ዜናን <em>ታሪኽን</em>',s6_desc:'እንጠብቆ — ብሰራሕተኛታት።',hello_title:'ሰላም በል — <b>ጽቕ</b> ነስትየካ።',news_btn:'ናብ ዝርዝር ጽምበር',f_visit:'በጽሕ',f_hours:'ሰዓታት',f_elsewhere:'ካልእ',empty_tray:'መሸጢኻ ባዕ እዩ።',pickup:'ምውሳድ',subtotal:'ንኡስ ድምር',checkout:'ክፈል ◆',pay_method:'መገዲ ክፍሊት ምረጽ',confirm:'ኣረጋግጽ',processing:'ይስራሕ...',cancel:'ሰርዝ',success:'ክፍሊት ዓዊቱ!',order_no:'ትእዛዝ',chat_greet:'ሰላም! ☕ ዛዕ ሜኑ ዋ፡ ሰዓት ሕተት።',chat_ph:'ዝደለኻዮ ሕተት…',bot_menu:'ኣብ ኑ',bot_price:'ዋጋ',bot_hours:'ክት ኢና',bot_loc:'ትረኽበና',bot_pay:'ንቕበል',bot_stamp:'ካርዲ፡ 7 ግእ 8ይ ነጻ',bot_events:'መጽእ መደባት',bot_brew:'መምርሒ ዳሎ',bot_langs:'እቲ ሳይት ዝረበን',bot_credit:'እዚ ፕሮጀት ብ',bot_fallback:'ሜኑ፡ ዋጋ ሰዓት፡ መደባት፡ ክፍሊት እፈልጥ — ትን!',back_shop:'← ናብ ድኳን',login:'እቶ',register:'ተመዝገብ',logout:'ውጻእ'},
...
function getSession(req) { const c = parseCookies(req); return c.moka_admin ? db.sessions.find(s => s.token === c.moka_admin) : null; }
...
function startSession(res, uname) {
  const token = crypto.randomBytes(24).toString('hex'); const prod = NODE_ENV === 'production';
  db.sessions.push({ token, user: uname, created: new Date().toISOString() }); save();
  res.setHeader('Set-Cookie', `moka_admin=${token}; Path=/; HttpOnly; SameSite=${prod ? 'None' : 'Strict'}; ${prod ? 'Secure; ' : ''}Max-Age=${SESSION_TTL / 1000}`);
  return token;
}
...
/* ================= 🤖 SMART BOT — knows the whole public site ================= */
function findItem(t) {
  let best = null, bs = 0;
...
function botReply(raw, lang) {
  ...
  if (/(language|translate|ቋንቋ|afaan|luqad|idioma|langue)/.test(t)) return `${d.bot_langs}: አማርኛ · English · العربية · Français · Español · Afaan Oromoo · ትግርኛ · Soomaali.`;
  if (/(stamp|free|ነፃ|ላሽ|bilaash|kaard|gratis)/.test(t)) return d.bot_stamp;
...
app.post('/api/admin/register', regLimiter, (req, res) => {
  ...
  db.users.push({ user: uname, hash: sha(pass), role: 'customer', provider: 'password', permissions: null, created: new Date().toISOString() });
  log(`New customer — ${uname}`); startSession(res, uname); save();
...
app.post('/api/admin/login', authLimiter, (req, res) => {
  ...
  if (ok) { log(`Logged in — ${uname}`); startSession(res, uname); return res.json({ ok: true, user: uname, role: acct.role }); }
  log('Failed login — ' + (uname || '?')); save();
  res.status(401).json({ error: 'Wrong username or password' });
});
app.post('/api/admin/logout', (req, res) => { const c = parseCookies(req); db.sessions = db.sessions.filter(s => s.token !== c.moka_admin); save(); res.setHeader('Set-Cookie', 'moka_admin=; Path=/; HttpOnly; Max-Age=0'); res.json({ ok: true }); });
...
app.get('/api/users', requireLogin, (req, res) => {
  ...
  res.json(db.users.map(u => ({ user: u.user, role: u.role, provider: u.provider || 'password', email: u.email || null, permissions: u.permissions || null, created: u.created, sessions: db.sessions.filter(s => s.user === u.user).length })));
});
app.delete('/api/users/:name', requireAdmin, (req, res) => {
  ...
  db.users.splice(i, 1); db.sessions = db.sessions.filter(s => s.user !== target);
...
app.post('/api/users/:name/logout', requireAdmin, (req, res) => {
  ...
  const before = db.sessions.length; db.sessions = db.sessions.filter(s => s.user !== target);
  log(`Admin kicked ${target}`); save(); res.json({ ok: true, killed: before - db.sessions.length });
});
