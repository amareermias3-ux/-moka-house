/* ================================================================
   MOKA HOUSE / ERSCOMAS — v7.7 (Gift cards + forgot password + 404)
================================================================ */
...
am:{board:'ሜኑው',brew:'ማፍያ ላብ',shops:'ሱቆች',club:'ስታምፕ ካርድ',events:'ዝግጅቶች',staff:'ሠራተኛ ⚿',tray:'መሸጫ',mast_copy:'ትንሽ-ርቢ ቡና፣ ማክሰ ሁሉ በኋለኛው ክፍል የተጠበሰ እና በሦስት ካውንተሮች ቀኑን ሙሉ የሚፍ።',cta1:'ሜኑውን ር ↓',cta2:'ኩፒንግ ያዝ',roast:'ዛሬ በባር ላይ →',open_closes:'ክፍት · ይዘጋል',closed_opens:'ዝግ · ይከፈታል',closed_day:'ዛሬ ግ ነው',s1_title:'ዛሬ <em>ምን አለ</em>',s1_desc:'ሁሉም በቤት ውስጥ የተዘጋጀ። ወደ መሸጫህ ጨምህ በምትልገው ዘዴ ክል',add:'+ ጨምር',soldout:'አልቋል',cat_all:'ሁሉም',cat_espresso:'ኤስሬሶ',cat_filter:'ፊልተር',cat_cold:'ቀዝቃዛ',cat_bakes:'ኬኮች',s2_title:'በቤት <em>አዘጋጅ</em>',s2_desc:'የባር ስነ-ህጎቻችን በቀጥ። ዴ ረጥ እና ከታይመር ጋር አዘጋጅ።',dose:'መጠን',ratio:'ሬሾ',water:'ውሃ',temp:'የውሃ ሙቀት',grind:'ፍት',timer:'ማፍያ ታይመር',start:'ማፍያ ጀምር ▸',s3_title:'ሦስት ክፍሎች፣ <em>አንድ ጥበስ</em>',s3_desc:'ቀጥታ የበር ሁኔታ፣ ከሰዓ።',s4_title:'ሰብ ግዛ፣ <em>ስምንተኛው በእኛ</em>',s4_desc:'በእያንዳንዱ መጠጥ አንድ ስታምፕ — ካርድህ ያስታውስሃል።',p1:'ካርዱ ሲሞላ ማንኛውም መጠን ነፃ መጠጥ',p2:'የእያንዳንዱ አዲስ ጥበስ የመጀመሪያ ቅዳ ለአባላት',p3:'በቡና ፍሬዎች 10% ቅናሽ፣ ሁልጊዜ',p4:'በአርብ ኩፒንጎች የመቀመ ቅድያ',collect:'የዛሬን ስምፕ ብስብ',s5_title:'ክፍለ-ጊዜች እና <em>ስነ-ጣም</em>',s5_desc:'መቀመጫዎች ውስን ናቸው — ያዙ።',seats:'መቀመጫዎች ቀርተዋል',reserve:'መቀመጫ ያዙ',s6_title:'ዜና እና <em>ታሪኮች</em>',s6_desc:'የምናጠሰው እና የምንቀዳው — በሠራተኞች የተለጠ።',hello_title:'ሰላም በል — <b>መልካም ነገር</b> እንቀዳልሃለን።',news_btn:'ወደ ዝርዝር ተላቀል',f_visit:'ጎብኝ',f_hours:'ሰዓት',f_elsewhere:'ሌም',empty_tray:'መሸጫህ ባ ነው',pickup:'መውሰጃ',subtotal:'ንዑስ ድምር',checkout:'ክፍያ ◆',pay_method:'የመክፈያ ዴ ምረጥ',confirm:'ክፍያውን አረጋግጥ',processing:'በሂደት ላይ...',cancel:'ይቅር',success:'ክፍያው ተሳክቷል!',order_no:'ትዕዛዝ',chat_greet:'ሰላም! ☕ ስለ ኑ ዋ፣ ዓት፣ ዝግጅት ወይም ማያ የለግክን ጠይቅ።',chat_ph:'የፈለክህን ይቅ…',bot_menu:'በሜኑ ላይ',bot_price:'ዋጋው',bot_hours:'ክፍት እንሆናለን',bot_loc:'የምንገኝበት',bot_pay:'የምንቀበላቸው',bot_stamp:'ስታምፕ ካርድ፦ 7 ግ፣ 8ኛው ነፃ።',bot_events:'የሚመጡ ዝግጅቶች',bot_brew:'የማፍያ መመሪያ',bot_langs:'ሳይቱ የሚናገራቸው',bot_credit:'የተሰራው በ',bot_fallback:'ሜኑን፣ ዋን፣ ሰዓትን፣ ዝግጅቶችን፣ ክያዎችን እና ማፍያን አውቃለሁ — ክረኝ!',back_shop:'← ወደ ሱቅ ተመለስ',login:'ግባ',register:'ተመዝገብ',logout:'ውጣ',track_order:'ትዕዛዝ ከታተል',my_orders:'የእኔ ትዕዛዞች'},
...
ti:{board:'ሜኑ',brew:'ላብ ን',shops:'ዱኳናት',club:'ካርዲ',events:'መደባት',staff:'ሰራሕተኛ ⚿',tray:'መሸጢ',mast_copy:'ንእሽቶ ጅምላ ቡን ሰሉስ ጠቢ ብሰለስተ ቦታ መዓልቲ ምሉእ ይስራብ።',cta1:'ሜኑ ርአ ↓',cta2:'ምስትምቓር ሓዝ',roast:'ሎሚ ኣብ ር →',open_closes:'ክፉት · ዕጾ',closed_opens:'ዕጹው · ክፈት',closed_day:'ሎሚ ዕጹው',s1_title:'ሎሚ <em>እንታይ ኣሎ</em>',s1_desc:'ኩሉ ኣብ ውሽጢ ይሎ ና መሸጢኻ ወስኽ።',add:'+ ወስኽ',soldout:'ወዲኡ',cat_all:'ኩሉ',cat_espresso:'ኤስፕሬሶ',cat_filter:'ፊልተር',cat_cold:'ዝሑል',cat_bakes:'ዳ',s2_title:'ብ ገዛ <em>ዳሎ</em>',s2_desc:'ሕግት ባርና። መገዲ ሓኻ ስ ታይመር ዳሎ',dose:'መን',ratio:'ሾ',water:'ማይ',temp:'ሙቐት ማይ',grind:'ጥነት',timer:'ይመር',start:'ምር ▸',s3_title:'ሰለስተ ክፍ፡ <em>ሓንቲ ጥብሲ</em>',s3_desc:'ኩነታት ብቐጥታ።',s4_title:'ሸውዓተ ግዛእ፡ <em>8ይ ብናትና</em>',s4_desc:'ንነፍሲ ወከ መስተ ንቲ ታምፕ።',p1:'ካርዲ ምስ መልአ ነ መስተ',p2:'ቀዳማይ ቡን ንኣላት',p3:'ኣብ ን 10% ርካሽ',p4:'ቀዳምነት መቐመጢ ዓርቢ',collect:'ስታምፕ ሎሚ',s5_title:'ክፍለ ግዜን <em>ምስትምቓርን</em>',s5_desc:'መቐመጢ ውሱን — ሓዝ።',seats:'መቐመጢ ተሪፉ',reserve:'መቐመጢ ሓዝ',s6_title:'ዜናን <em>ታሪኽን</em>',s6_desc:'እንጠብቖ — ብሰራሕተኛታት',hello_title:'ሰም በል — <b>ጽቡቕ</b> ከስትየካ።',news_btn:'ናብ ዝርር ጽምበር',f_visit:'በጽሕ',f_hours:'ሰዓታት',f_elsewhere:'ካልእ',empty_tray:'መሸጢኻ  እዩ',pickup:'ምውሳድ',subtotal:'ንኡስ ድምር',checkout:'ክፈል ◆',pay_method:'መገዲ ክፍሊት ረ',confirm:'ኣረጋግጽ',processing:'ይስራሕ...',cancel:'ሰርዝ',success:'ክፍሊት ዓዊ!',order_no:'ትእዝ',chat_greet:'ሰላም! ☕ ብዛዕባ ሜኑ ዋ፣ ዓት መደት ሕተት።',chat_ph:'ዝደለኻዮ ሕተት…',bot_menu:'ኣብ ሜኑ',bot_price:'ዋጋኡ',bot_hours:'ክፉታት ኢና',bot_loc:'ትረኽበና',bot_pay:'ንቕበሎም',bot_stamp:'ካርዲ፡ 7 ዛእ 8ይ ነጻ',bot_events:'መጺኦም መደባት',bot_brew:'መምርሒ ዳሎ',bot_langs:'እቲ ሳይት ዝዛረበን',bot_credit:'ዝተሰርሐ ብ',bot_fallback:'ሜኑ ዋ፣ ዓት መደት፣ ክፍት እልጥ — ትን!',back_shop:'← ናብ ዱን',login:'እቶ',register:'ተመዝገብ',logout:'ውጻእ',track_order:'ትእዛዝ ስዓ',my_orders:'ትእዛዛተይ'},
...
am:{register:'መለያ ለመፍር፦ Register ገጽ ላይ ስም፣ ኢሜይል፣ ልክ እና የይለፍ ል ሞላ — ወይም "በGoogle ተመዝገ"።',login:'በተጠሚ ም ወይም ኢሜይል + የይለፍ ቃል ግባ — ወይም በGoogle።',wallet:'ቴሌ ብር፣ ኤም-ሳ PayPal፣ ካርድ፣ ባንክ እና ክሪፕ እንቀበላለን።',stamps:'ስታምፕ ካርድ፦ በእያንዳንዱ መጠጥ አንድ ስምፕ — 7 ገዝተህ 8ኛው ነፃ።',new:'አዲስ ዜና፦ ',langs:'ሳይቱ በ8 ቋንቋዎች ይናገራል — ከላይ ቀኝ መቀየር ትችላለህ።',delivery:'እስካሁን አናደርስም — በሦስቱም ሱቆችን ተከብ።'},
...
ti:{register:'ሕሳ ንምፍጣር ኣብ Register ም፡ ኢመይል፡ ስልክን ፓስዎርድን መላእ — ወይ ብGoogle።',login:'ብስም ይ ኢመይል + ፓስዎርድ እቶ፡ ወይ ብGoogle',wallet:'Telebirr, M-Pesa, PayPal, ካርድ, ባንክን ክሪፕቶን ንበል።',stamps:'ካርዲ፡ ንነፍሲ ከፍ መስተ ሓንቲ ስታምፕ — 7 ግዛእ 8ይ ነጻ።',new:'ሓድሽ ዜና፦ ',langs:'እቲ ሳይት 8 ቋንቋታት ይዛብ — ካብ ላሊ ቀያይር።',delivery:'ኣየብጽን — ኣ ሰለስተ ኳናትና ቐበል።'},
...
const HTML_PAGES = { '/': 'index.html', '/index.html': 'index.html', '/login.html': 'login.html', '/register.html': 'register.html', '/admin.html': 'admin.html', '/track.html': 'track.html', '/quiz.html': 'quiz.html', '/story.html': 'story.html', '/friends.html': 'friends.html', '/terms.html': 'terms.html', '/wholesale.html': 'wholesale.html', '/gift.html': 'gift.html' };
...
/* ================= 💰 WALLET (with gift-code discount) ================= */
...
if (!IS_VERCEL) {
  app.listen(PORT, () => console.log(`\n   ☕ ERSCOMAS · ${NODE_ENV}\n   → http://localhost:${PORT}\n   🎁 Gift cards · 🔑 Reset · 🛡️ Security · ✍️ ERMIAS AMARE\n`));
}
export default app;