/* ================================================================
   MOKA HOUSE / ERSCOMAS — v7.4 (fx.js loaded + clean i18n)
================================================================ */
...
am:{board:'ሜኑው',brew:'ማፍያ ላብ',shops:'ሱቆች',club:'ስታምፕ ካርድ',events:'ዝግጅቶች',staff:'ሠራተኛ ⚿',tray:'መሸጫ',mast_copy:'ትንሽ-ርብ ቡና፣ ማክሰኞ ሁሉ በኋለኛው ክፍል የተጠበ እና በሦስት ካውንተሮች ቀኑን ሙሉ የሚቀ',cta1:'ሜኑውን ርአ ↓',cta2:'ኩፒንግ ያ',roast:'ዛሬ በባር ላይ →',open_closes:'ክፍት · ይዘል',closed_opens:'ዝግ · ይከፈታል',closed_day:'ዛሬ ግ ነው',s1_title:'ዛሬ <em>ምን አለ</em>',s1_desc:'ሁሉም በቤት ውስጥ የተጋጀ። ወደ መሸጫ ጨምህ በምትፈልገው ዘዴ ክል።',add:'+ ጨምር',soldout:'አልቋል',cat_all:'ሁሉም',cat_espresso:'ኤስፕሬሶ',cat_filter:'ፊልተር',cat_cold:'ቀዝዛ',cat_bakes:'ኬኮች',s2_title:'በቤት <em>አዘጋጅ</em>',s2_desc:'የባር ስነ-ህጎቻችን በቀጥ። ዘ ምረ እና ከይመር ር አዘጅ',dose:'መጠን',ratio:'ሬሾ',water:'ውሃ',temp:'የውሃ ሙቀት',grind:'ፍጭት',timer:'ማፍያ ታይመር',start:'ማፍያ ጀምር ▸',s3_title:'ሦስት ክፍሎች፣ <em>አንድ ጥበስ</em>',s3_desc:'ቀጥታ የበር ሁኔታ፣ ከሰዓ።',s4_title:'ሰ ግዛ <em>ስምንተኛው በእኛ</em>',s4_desc:'በእያንዳንዱ መጠጥ አንድ ስታምፕ — ካርድህ ያስታውስሃል።',p1:'ካርዱ ሲሞላ ማንኛውም መጠን ነፃ መጠጥ',p2:'የእያንዳንዱ አዲስ ጥበስ የመጀመሪያ ቅ ለአባት',p3:'በቡና ፍሬዎች 10% ቅናሽ፣ ሁልጊዜ',p4:'በአርብ ኩፒንጎች የመቀመ ቅድያ',collect:'የዛሬን ስታምፕ ሰብስብ',s5_title:'ክፍለ-ጊዜዎች እና <em>ስነ-ጣም</em>',s5_desc:'መቀመጫዎች ውስን ናቸው — ያ።',seats:'መቀመጫዎች ቀርተል',reserve:'መቀመጫ ያዙ',s6_title:'ዜና እና <em>ታሪኮች</em>',s6_desc:'የምናጠሰው እና የምንቀዳው — በሠራተኞች የተለጠ።',hello_title:'ሰላም በል — <b>መልካም ነገር</b> እንቀልሃለን',news_btn:'ወ ዝርዝር ተቀቀል',f_visit:'ጎብኝ',f_hours:'ሰዓት',f_elsewhere:'ሌላም',empty_tray:'መሸጫ ባዶ ነው።',pickup:'መውሰጃ',subtotal:'ንዑስ ድምር',checkout:'ክፍያ ◆',pay_method:'የመክፈያ ዴ ምረጥ',telebirr:'ቴብር',mpesa:'ኤም-ፔሳ',paypal:'PayPal',card:'ካርድ',bank:'ባንክ',crypto:'ክሪቶ',phone:'ስልክ ቁጥር (የራስህ)',email:'ኢሜይል',card_number:'የካርድ ቁጥር',expiry:'ማብቂያ',cvv:'CVV',bank_name:'ባንክህ',account:'የሂሳብ ቁር',wallet_address:'የዋሌት አድራሻ',confirm:'ክፍያውን አረጋግጥ',processing:'በሂደት ይ...',cancel:'ይቅር',success:'ክፍያው ተሳክቷል!',pending_title:'ክፍያህን በማረጋገጥ ላይ',pending_note:'ክፍያህ ሲደርስ በእጅ እናረጋግጣለን። ትዛዝህ በወረ ውስ ነው',order_no:'ትዕዛዝ',chat_greet:'ሰላም! ☕ ስለ ሜኑ፣ ዋጋ ሰዓት፣ ዝግጅት ወይም ማፍያ የፈለግክህን ጠይቅ።',chat_ph:'የፈለግክህን ጠይቅ…',bot_menu:'በሜኑ ላይ',bot_price:'ዋጋው',bot_hours:'ክፍት እንሆናለን',bot_loc:'የምንገኝበት',bot_pay:'የምንቀበላቸው',bot_stamp:'ስታምፕ ካርድ፦ 7 ግ፣ 8ኛው ነፃ።',bot_events:'የሚመጡ ዝግጅቶች',bot_brew:'የማፍያ መመሪያ',bot_langs:'ሳይቱ የሚናገራቸው',bot_credit:'የተሰራው በ',bot_fallback:'ሜኑን፣ ዋን ሰዓትን፣ ዝግጅቶችን፣ ክፍያዎችን እና ማፍያን አውቃለሁ — ክረ!',back_shop:'← ደ ሱቅ ተመለስ',login:'ግ',register:'ተመዝገብ',logout:'ውጣ',track_order:'ትዕዛዝ ከታተል',my_orders:'የእኔ ትዛዞች'},
...
ti:{board:'ሜኑ',brew:'ላብ ቡን',shops:'ዱኳናት',club:'ካርዲ',events:'መደባት',staff:'ሰራሕተኛ ⚿',tray:'መሸጢ',mast_copy:'ንእሽቶ ምላ ን፡ ሉስ ኣብ ድሕሪት ዝጠበሰ፡ መዓልቲ ምሉእ ኣብ ሰለስተ ቦ ዝስራብ።',cta1:'ሜኑ አ ↓',cta2:'ምስትምቓር ሓዝ',roast:'ሎሚ ኣብ ር →',open_closes:'ክፉት · ይዕጾ',closed_opens:'ዕጹው · ይኽፈት',closed_day:'ሎሚ ጹው',s1_title:'ሎሚ <em>እንታይ ኣሎ</em>',s1_desc:'ኩሉ ኣብ ውሽጢ ዝተዳለወ። ና መሸጢኻ ወስኽ ብደለኻዮ መገዲ ክፈል።',add:'+ ወስኽ',soldout:'ወዲኡ',cat_all:'ኩሉ',cat_espresso:'ኤስፕሬሶ',cat_filter:'ፊልተር',cat_cold:'ዝሑል',cat_bakes:'ዳቦ',s2_title:'ኣብ ዛ <em>ዳሎ</em>',s2_desc:'ሕግታት ባርና ብጥ። መገዲ ምጽ ስ ታይመር ዳሎ።',dose:'መጠን',ratio:'ሬ',water:'ማይ',temp:'ሙቐት ማይ',grind:'ጥነት',timer:'ይመር ቡን',start:'ጀምር ▸',s3_title:'ሰለስተ ክፍ፡ <em>ንቲ ብሲ</em>',s3_desc:'ኩነታት በሪ ብቐጥ።',s4_title:'ሸውዓተ ግዛእ፡ <em>8ይ ብናትና</em>',s4_desc:'ንነፍሲ ወከፍ መስተ ሓንቲ ስታምፕ።',p1:'ካርዲ ምስ መልአ ነ መስተ',p2:'ቀዳማይ ቡን ንኣላት',p3:'ኣብ ን 10% ርካሽ',p4:'ቀዳምነት መቐመጢ ዓርቢ',collect:'ስታምፕ ሎሚ',s5_title:'ክፍለ-ግን <em>ምስትምቓርን</em>',s5_desc:'መቐመጢ ውሱን — ሓዝ።',seats:'መቐመጢ ተሪፉ',reserve:'መቐመጢ ሓዝ',s6_title:'ዜናን <em>ታሪን</em>',s6_desc:'እንጠብሖን እነቕርቦን — ብሰራሕተኛታት።',hello_title:'ሰላም በል — <b>ጽቡቕ</b> ከስትየካ።',news_btn:'ናብ ዝርዝር ጽምበር',f_visit:'በጽሕ',f_hours:'ሰዓት',f_elsewhere:'ካልእ',empty_tray:'መሸጢኻ ባዶ እዩ።',pickup:'ምውሳድ',subtotal:'ንኡስ ድምር',checkout:'ክፈል ◆',pay_method:'መገዲ ክፍሊት ምረጽ',telebirr:'Telebirr',mpesa:'M-Pesa',paypal:'PayPal',card:'ካርድ',bank:'ባንክ',crypto:'Crypto',phone:'ቁጽሪ ተሌፎን',email:'ኢመይል',card_number:'ቁጽሪ ካርድ',expiry:'ምብቃዕ',cvv:'CVV',bank_name:'ባንክኻ',account:'ቁጽሪ ሂሳብ',wallet_address:'ኣድራ ዋሌት',confirm:'ኣረግጽ',processing:'ይስራሕ ሎ...',cancel:'ሰርዝ',success:'ክፍሊት ዓዊቱ!',pending_title:'ክፍሊትካ ይጋጽ ኣሎ',pending_note:'ክፍሊትካ ምስ በጽሐ ብኢድ ክንረጋግጾ ኢና። ትእዛዝካ ኣብ ረ ኣሎ።',order_no:'ትእዛዝ',chat_greet:'ሰላም! ☕ ብዛዕባ ሜኑ ዋ፡ ዓት፡ መደባት ሕተት።',chat_ph:'ዝደለኻዮ ሕተት…',bot_menu:'ኣብ ኑ',bot_price:'ዋጋኡ',bot_hours:'ክፉታት ኢና',bot_loc:'ትረኽበና',bot_pay:'ንቕበሎም',bot_stamp:'ካርዲ፡ 7 ግእ 8ይ ነጻ',bot_events:'መጹ መደባት',bot_brew:'መምርሒ ቡን',bot_langs:'እቲ ሳይት ዝዛረበን',bot_credit:'ዝተሰርሐ ብ',bot_fallback:'ሜኑ ዋ፡ ዓት፡ መደባት፡ ክፍሊት እፈልጥ — ትን!',back_shop:'← ናብ ኳን',login:'እቶ',register:'ተመዝገብ',logout:'ውጻእ',track_order:'ትእዛዝ ስዓ',my_orders:'ትእዛዛተይ'},
...
am:{register:'መለያ ለመፍጠር፦ Register ገጽ ላይ ስም፣ ኢሜይል፣ ስልክ እና የይለፍ ቃል ሞላ — ወይም "በGoogle ተመዝገ"።',login:'በተጠሚ ም ወይም ኢሜይል + የይለፍ ቃል ግባ — ወይም በGoogle።',wallet:'ቴሌብር፣ ኤም-ፔሳ PayPal፣ ካርድ፣ ባንክ እና ክሪፕ እንቀበላለን።',stamps:'ስታምፕ ካርድ፦ በእያንዳንዱ መጠጥ አንድ ስታምፕ — 7 ግዛ፣ 8ኛው ነፃ።',new:'አዲስ ዜና ',langs:'ይቱ በ8 ቋንቋዎች ይናገራል — ከላይ ቀኝ መቀየር ትችላለህ።',delivery:'እስካሁን አናደርስም — በሦስቱም ሱቆችን ተከብ።'},
...
ti:{register:'ሕሳ ንምፍጣር፡ ኣ Register ስም፡ ኢመይል፡ ስልክን ፓስዎርድን መላእ — ወይ ብGoogle።',login:'ብስም ወይ ኢመይል + ፓስዎርድ እቶ፡ ወይ ብGoogle።',wallet:'Telebirr, M-Pesa, PayPal, ካርድ, ባንክን ክሪፕቶን ንቕበል።',stamps:'ካርዲ፡ ንነፍሲ ወከፍ መስተ ሓንቲ ስታምፕ — 7 ግዛእ 8ይ ነጻ',new:'ድሽ ዜና፦ ',langs:'እቲ ሳይት 8 ቋንቋታት ይዛረብ — ካብ ላዕሊ ቀያይር።',delivery:'ኣየብጽሕን — ብ ሰለስተ ዱኳናትና ተበል።'},
...
function botReply(raw, lang) {
  ...
  if (/(register|signup|sign up|create|account|መመዝገብ|ተመዝገ|መለያ|galmaa|diiwaan|registrar)/.test(t)) return x.register;
...
if (!IS_VERCEL) {
  app.listen(PORT, () => console.log(`\n   ☕ ERSCOMAS · ${NODE_ENV}\n   → http://localhost:${PORT}\n   🎨 fx.js design · 🛡️ Security · ✍️ ERMIAS AMARE\n`));
}
export default app;