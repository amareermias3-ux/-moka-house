/* ================================================================
   MOKA HOUSE / ERSCOMAS — v7.5 (process.cwd → fx.js on ALL pages)
================================================================ */
...
const ROOT = process.cwd(); /* ✅ Vercel + local both resolve to project root */
...
am:{board:'ሜኑው',brew:'ማፍያ ብ',shops:'ቆች',club:'ስታምፕ ርድ',events:'ግቶች',staff:'ራተኛ ',tray:'መሸጫ',mast_copy:'ትንሽ-ርብ ቡና፣ ማክሰኞ ሁሉ በኋለኛው ክፍል የተጠበሰ እና በሦስት ካውንተሮች ቀኑን ሙሉ የሚ።',cta1:'ሜኑውን ርአ ↓',cta2:'ኩፒንግ ያዝ',roast:'ዛሬ በባር ላይ →',open_closes:'ክፍት · ይዘጋል',closed_opens:'ዝግ · ይከታል',closed_day:'ዛሬ ግ ነው',s1_title:'ዛሬ <em>ምን አለ</em>',s1_desc:'ሁሉም በቤት ውስጥ የተዘጋጀ። ወደ መሸጫ ጨምህ በምትፈልገው ዘዴ ክል።',add:'+ ጨምር',soldout:'አልቋል',cat_all:'ሁሉም',cat_espresso:'ኤስሬሶ',cat_filter:'ፊልተር',cat_cold:'ቀዝቃዛ',cat_bakes:'ኬኮች',s2_title:'በቤት <em>አዘጋጅ</em>',s2_desc:'የባር ስነ-ህጎቻችን በቀጥ። ዘ ምጥ እና ከታይመር ጋር አዘጋጅ',dose:'መጠን',ratio:'ሬሾ',water:'ውሃ',temp:'የውሃ ሙቀት',grind:'ፍጭት',timer:'ማፍያ ታይመር',start:'ማፍያ ጀምር ▸',s3_title:'ሦስት ክፍች፣ <em>አንድ ጥበስ</em>',s3_desc:'ቀጥታ የበር ሁኔታ፣ ከሰዓ።',s4_title:'ሰብ ዛ <em>ስምንተኛው በእኛ</em>',s4_desc:'በእያንዳንዱ መጠጥ አንድ ስታምፕ — ካርድህ ስታውስሃል።',p1:'ካርዱ ሲሞላ ማንኛውም መጠን ነፃ መጠጥ',p2:'የእያንዳንዱ አዲስ ጥበስ የመጀመሪያ ዳ ለአባላት',p3:'በቡና ፍሬዎች 10% ቅናሽ፣ ሁልጊዜ',p4:'በአርብ ኩፒንጎች የመቀመጫ ቅድሚያ',collect:'የዛሬን ስታም ሰብስብ',s5_title:'ክፍለ-ጊዜች እና <em>ስነ-ጣም</em>',s5_desc:'መቀመጫዎች ውስን ናቸው — ያዙ።',seats:'መቀመጫዎች ቀርተዋል',reserve:'መቀመጫ ያዙ',s6_title:'ዜና እና <em>ታሪኮች</em>',s6_desc:'የምናጠሰው እና የምንቀዳው — በሠራተኞች የተለጠ።',hello_title:'ሰላም በል — <b>መልካም ነገር</b> እንቀዳልሃለን።',news_btn:'ወደ ርዝር ተላቀል',f_visit:'ጎብኝ',f_hours:'ሰዓት',f_elsewhere:'ሌላም',empty_tray:'መሸጫህ ዶ ነው።',pickup:'መውሰጃ',subtotal:'ንዑስ ድምር',checkout:'ክፍያ ◆',pay_method:'የመክፈያ ዴ ምረጥ',telebirr:'ቴሌብር',mpesa:'ኤም-ፔሳ',paypal:'PayPal',card:'ካርድ',bank:'ባንክ',crypto:'ክሪቶ',phone:'ስልክ ቁጥር (የራስህ)',email:'ኢሜይል',card_number:'የካርድ ቁጥር',expiry:'ማብቂያ',cvv:'CVV',bank_name:'ባንክህ',account:'የሂሳብ ቁር',wallet_address:'የዋሌት አድራሻ',confirm:'ክፍያውን አረጋግጥ',processing:'በሂደት ይ...',cancel:'ይቅር',success:'ክፍያው ተሳክቷል!',pending_title:'ክፍያህን በማረጋገጥ ላይ',pending_note:'ክፍያህ ሲደርስ በእጅ እናረጋግጣለን ትዛዝህ በወረፋ ውስጥ ነው።',order_no:'ትዕዛዝ',chat_greet:'ሰላም! ☕ ስለ ሜኑ ዋ፣ ዓት፣ ዝግጅት ወይም ማያ የለግክን ጠይቅ።',chat_ph:'የፈለክህን ይቅ…',bot_menu:'በሜኑ ላይ',bot_price:'ዋጋው',bot_hours:'ክፍት እንሆናለን',bot_loc:'የምንገኝበት',bot_pay:'የምንቀበላው',bot_stamp:'ስታምፕ ካርድ፦ 7 ግ፣ 8ው ነ።',bot_events:'የሚመጡ ዝግጅቶች',bot_brew:'የማፍያ መመሪያ',bot_langs:'ሳይቱ የሚናገራቸው',bot_credit:'የተሰራው በ',bot_fallback:'ሜኑን፣ ዋጋን፣ ሰዓትን፣ ዝግጅቶችን፣ ክፍያዎችን እና ማፍያን አውቃለሁ — ክረኝ!',back_shop:'← ወደ ሱቅ መለስ',login:'ግባ',register:'ተመዝገብ',logout:'ውጣ',track_order:'ትዕዛዝ ታተል',my_orders:'የእኔ ትዛዞች'},
...
am:{register:'መለያ ለመፍጠር፦ Register ገጽ ላይ ስም፣ ኢሜይል፣ ስልክ እና የይለፍ ቃል ላ — ወይም "በGoogle ተመዝገብ"።',login:'በተጠሚ ስም ወይም ኢሜይል + የይለፍ ቃል ግ — ወይም በGoogle።',wallet:'ቴሌብር፣ ኤም-ፔሳ PayPal፣ ካርድ፣ ባንክ እና ክሪፕ እንቀበላለን።',stamps:'ስታምፕ ካርድ፦ በእያንዳንዱ መጠጥ አንድ ስታምፕ — 7 ግዛ 8ኛው ነፃ።',new:'አዲስ ዜና ',langs:'ይቱ በ8 ንቋዎች ይናገራል — ከላይ ቀኝ መቀየር ትችላለህ።',delivery:'እስካሁን አናደርስም — በሦስቱም ሱቆቻችን ተከበብ።'},
...
ti:{register:'ሕሳብ ንምፍጣር ኣብ Register ም፡ መይል ስልክን ፓስዎርድን መላእ — ወይ ብGoogle።',login:'ብስም ይ ኢመይል + ፓስዎርድ እቶ፡ ወይ ብGoogle',wallet:'Telebirr, M-Pesa, PayPal, ካርድ, ባንክን ክሪፕቶን ንበል።',stamps:'ካርዲ፡ ንነፍሲ ወከፍ መስተ ሓንቲ ስታም — 7 ዛእ 8ይ ነጻ።',new:'ሓድሽ ዜና፦ ',langs:'እቲ ሳይት 8 ቋንታት ይረብ — ካብ ላዕ ቀያይር',delivery:'ኣየብጽን — ኣ ሰለስተ ኳናትና ቐበል'},
...
function botReply(raw, lang) {
  ...
  if (/(stamp|free|ነፃ|ብላ|bilaash|kaard|gratis)/.test(t)) return x.stamps;
  ...
  if (/(leaderboard|vip|top|loyal|ደረጃ)/.test(t)) return '🏆 VIP Leaderboard: /leaderboard.html — climb to Roaster 👑!';
...
/* ===== injected: fx.js FIRST + floats + beacon (uses ROOT) ===== */
const CREDIT_HTML = `
...
const HTML_PAGES = { '/': 'index.html', '/index.html': 'index.html', '/login.html': 'login.html', '/register.html': 'register.html', '/admin.html': 'admin.html', '/track.html': 'track.html', '/quiz.html': 'quiz.html', '/story.html': 'story.html', '/friends.html': 'friends.html', '/terms.html': 'terms.html', '/wholesale.html': 'wholesale.html', '/gift.html': 'gift.html', '/subscribe.html': 'subscribe.html', '/receipt.html': 'receipt.html', '/leaderboard.html': 'leaderboard.html' };
...
if (!IS_VERCEL) {
  app.listen(PORT, () => console.log(`\n   ☕ ERSCOMAS · ${NODE_ENV}\n   → http://localhost:${PORT}\n   🎨 fx.js everywhere · 🛡️ Security · ✍️ ERMIAS AMARE\n`));
}
export default app;