/* ================================================================
   MOKA HOUSE — v7.6 (404 catch-all + terms + everything)
================================================================ */
...
am:{board:'ሜኑው',brew:'ማፍያ ላብ',shops:'ሱቆች',club:'ስታምፕ ካርድ',events:'ዝግጅቶች',staff:'ሠራተኛ ⚿',tray:'መሸጫ',mast_copy:'ትንሽ-ርቢ ቡና፣ ማክሰ ሁሉ በኋለኛው ክፍል የተጠበሰ እና በሦስት ካውንተሮች ቀኑን ሙሉ የሚቀ።',cta1:'ሜኑውን ር ↓',cta2:'ኩፒንግ ያ',roast:'ዛሬ በባር ላይ →',open_closes:'ክፍት · ይዘጋል',closed_opens:'ዝግ · ይከታል',closed_day:'ዛሬ ግ ነው',s1_title:'ዛሬ <em>ምን አለ</em>',s1_desc:'ሁሉም በቤት ውስጥ የተዘጋጀ። ወደ መሸጫህ ጨምረህ በምትፈልገው ዘዴ ክፈል',add:'+ ጨምር',soldout:'አልቋል',cat_all:'ሁሉም',cat_espresso:'ኤስፕሬሶ',cat_filter:'ፊልተር',cat_cold:'ቀዝቃዛ',cat_bakes:'ኬኮች',s2_title:'በቤት <em>አዘጋጅ</em>',s2_desc:'የባር ስነ-ህጎቻችን በቀጥ። ዘዴ ምጥ እና ከታይመር ጋር አዘጋጅ',dose:'መጠን',ratio:'ሬሾ',water:'ውሃ',temp:'የውሃ ሙቀት',grind:'ፍጭት',timer:'ማፍያ ታይመር',start:'ማፍያ ጀምር ▸',s3_title:'ሦስት ክፍች፣ <em>አንድ ጥበስ</em>',s3_desc:'ቀጥታ የበር ሁኔታ፣ ከሰዓቱ።',s4_title:'ሰብ ዛ <em>ስምንተኛው በእኛ</em>',s4_desc:'በእያንዳንዱ መጠጥ አንድ ስምፕ — ካርድህ ስታውስሃል።',p1:'ካርዱ ሲሞላ ማንኛውም መጠን ነፃ መጠጥ',p2:'የእያንዳንዱ አዲስ ጥበስ የመጀመሪያ ቅዳ ለአባላት',p3:'በቡና ፍሬዎች 10% ቅናሽ፣ ሁልጊዜ',p4:'በአርብ ኩፒንጎች የመቀመጫ ቅድሚያ',collect:'የዛሬን ስታም ሰስብ',s5_title:'ክፍለ-ጊዜች እና <em>ስነ-ጣም</em>',s5_desc:'መቀመጫዎች ውስን ናቸው — ያዙ',seats:'መቀመጫዎች ቀርተል',reserve:'መቀመጫ ያዙ',s6_title:'ዜና እና <em>ታሪች</em>',s6_desc:'የምናጠብሰው እና የምንቀዳው — በሠራተኞች የተለጠ።',hello_title:'ሰላም በል — <b>መልካም ነገር</b> እንቀዳልሃለን።',news_btn:'ወደ ርዝር ተላቀል',f_visit:'ጎብኝ',f_hours:'ሰዓት',f_elsewhere:'ሌላም',empty_tray:'መሸጫህ ባ ነው',pickup:'መውሰጃ',subtotal:'ንዑስ ድምር',checkout:'ክፍያ ◆',pay_method:'የመክያ ዘ ምረ',confirm:'ክያውን አረጋግጥ',processing:'በሂደት ይ...',cancel:'ይቅር',success:'ክፍያው ተሳክቷል!',order_no:'ትዕዛዝ',chat_greet:'ሰላም! ☕ ስለ ኑ ዋ፣ ዓት፣ ዝግጅት ወይም ማፍያ የፈለክህን ይቅ',chat_ph:'የለግክህን ጠይቅ…',bot_menu:'በሜኑ ይ',bot_price:'ዋጋው',bot_hours:'ክፍት እንሆናለን',bot_loc:'የምንገኝበት',bot_pay:'የምንቀበላቸው',bot_stamp:'ስታምፕ ካርድ፦ 7 ግ፣ 8ኛው ነፃ።',bot_events:'የሚመጡ ዝግጅቶች',bot_brew:'የማፍያ መመሪያ',bot_langs:'ሳይቱ የሚናገራው',bot_credit:'የተሰራው በ',bot_fallback:'ሜኑን፣ ዋጋን፣ ዓትን፣ ዝግጅቶችን፣ ክፍያዎችን እና ማፍያን አውቃለሁ — ሞክረኝ!',back_shop:'← ወደ ሱቅ ተመለስ',login:'ግ',register:'ተመዝገብ',logout:'ውጣ',track_order:'ትዕዛዝ ከታተል',my_orders:'የእኔ ትዕዛዞች'},
...
ti:{board:'ሜኑ',brew:'ላብ ን',shops:'ኳናት',club:'ካርዲ',events:'መደባት',staff:'ሰራሕተኛ ⚿',tray:'መሸጢ',mast_copy:'ንእሽቶ ጅምላ ቡን ሰሉስ ጠ ብሰለስተ ቦታ መዓልቲ ምሉእ ይስራብ።',cta1:'ሜኑ ርአ ↓',cta2:'ምስትምቓር ሓዝ',roast:'ሎሚ ኣብ ር →',open_closes:'ክፉት · ዕጾ',closed_opens:'ዕጹው · ክፈት',closed_day:'ሎሚ ዕጹው',s1_title:'ሎሚ <em>እንታይ ኣሎ</em>',s1_desc:'ኩሉ ኣብ ውጢ ይዳሎ ናብ መሸጢኻ ወስኽ።',add:'+ ወስኽ',soldout:'ወዲኡ',cat_all:'ኩሉ',cat_espresso:'ኤስሬሶ',cat_filter:'ፊልተር',cat_cold:'ዝሑል',cat_bakes:'ዳቦ',s2_title:'ኣብ ገዛ <em>ዳሎ</em>',s2_desc:'ሕግት ባርና። መገዲ ሓኻ ስ ታይመር ዳሎ።',dose:'መጠን',ratio:'ሬሾ',water:'ማይ',temp:'ሙቐት ማይ',grind:'ጥሕነት',timer:'ታይመር',start:'ጀምር ▸',s3_title:'ሰለስተ ክፍሊ፡ <em>ሓንቲ ጥብሲ</em>',s3_desc:'ኩነታት ብቐጥታ።',s4_title:'ሸውዓተ ግዛእ፡ <em>8ይ ብናትና</em>',s4_desc:'ንነፍሲ ወከፍ መስተ ሓንቲ ስታምፕ።',p1:'ካርዲ ምስ መልአ ነ መስተ',p2:'ቀዳማይ ቡን ንኣላት',p3:'ኣብ ን 10% ርካ',p4:'ዳምነት መቐመጢ ዓርቢ',collect:'ስታምፕ ሎሚ',s5_title:'ክፍለ ግዜን <em>ምስትምቓርን</em>',s5_desc:'መቐመጢ ውሱን — ሓዝ።',seats:'መቐመጢ ተሪ',reserve:'መቐመጢ ሓዝ',s6_title:'ዜናን <em>ታሪኽን</em>',s6_desc:'እንጠብቖ — ብሰሕተኛት።',hello_title:'ሰላም በል — <b>ጽቡቕ</b> ከስትየካ።',news_btn:'ናብ ዝርዝር ምበር',f_visit:'በጽሕ',f_hours:'ሰዓት',f_elsewhere:'ካልእ',empty_tray:'መሸጢኻ ዶ እዩ።',pickup:'ምውሳድ',subtotal:'ንኡስ ድምር',checkout:'ክፈል ◆',pay_method:'መገዲ ክፍሊት ረ',confirm:'ረጋግጽ',processing:'ይስራሕ...',cancel:'ሰርዝ',success:'ክፍት ዓወተ!',order_no:'ትእዛዝ',chat_greet:'ሰላም! ☕ ብዛዕባ ሜኑ ዋ፡ ዓት መደት ሕተት።',chat_ph:'ዝደለኻዮ ሕተት…',bot_menu:'ኣብ ሜኑ',bot_price:'ዋጋ',bot_hours:'ፉታት ኢና',bot_loc:'ትረኽበና',bot_pay:'ንቕበሎም',bot_stamp:'ካርዲ፡ 7 ዛእ 8ይ ነጻ',bot_events:'መኦም መደት',bot_brew:'መምርሒ ዳሎ',bot_langs:'እቲ ሳይት ዝዛረበን',bot_credit:'ዝተሰርሐ ብ',bot_fallback:'ሜኑ ዋ፣ ዓት፣ መደባት፣ ክፍሊት እፈልጥ — ትን!',back_shop:'← ናብ ዱን',login:'እቶ',register:'ተመዝገብ',logout:'ውጻእ',track_order:'ትእዛዝ ስዓ',my_orders:'ትእዛዛተይ'},
...
function load() {
  try { fs.mkdirSync(path.dirname(DB_PATH), { recursive: true }); return JSON.parse(fs.readFileSync(DB_PATH, 'utf8')); }
    ...
    return { orders: [], newsletter: [], menu: [], events: SEED_EVENTS, posts: SEED_POSTS, knowledge: SEED_KNOWLEDGE, activity: [], sessions: [], users: [], transactions: [], wallet: { balance: 0, totalReceived: 0 } };
  }
}
const db = load();
...
am:{register:'መለያ ለመፍር፦ Register ጽ ላይ ስም፣ ኢሜይል፣ ልክ እና የይለፍ ቃል ላ — ወይም "በGoogle ተመዝገ"።',login:'በተጠሚ ስም ወይም ኢሜይል + የይለፍ ቃል ግባ — ወይም በGoogle።',wallet:'ቴሌ ብር፣ ኤም-ፔሳ PayPal፣ ካርድ፣ ባンክ እና ክሪፕ እንቀበላለን።',stamps:'ስታምፕ ካርድ፦ በእያንዳንዱ መጠጥ አንድ ስምፕ — 7 ገዝተህ 8ኛው ነፃ።',new:'አዲስ ዜና ',langs:'ይቱ በ8 ንቋዎች ይናገራል — ከላይ ቀኝ መቀየር ትችላለህ።',delivery:'እስካሁን አናደርስም — በሦስቱም ሱቆቻችን ተረከብ።'},
...
ti:{register:'ሕሳብ ንምፍጣር ኣብ Register ም፡ ኢመይል፡ ስልክን ፓስዎርድን መላእ — ወይ ብGoogle።',login:'ብስም ይ ኢመይል + ፓስዎርድ እቶ፡ ወይ ብGoogle።',wallet:'Telebirr, M-Pesa, PayPal, ካርድ, ባንክን ክሪፕቶን ንበል።',stamps:'ካርዲ፡ ንነፍሲ ወከፍ መስተ ሓንቲ ስታምፕ — 7 ግዛእ 8ይ ነጻ።',new:'ሓድሽ ዜና፦ ',langs:'እቲ ሳይት 8 ቋንቋታት ይዛረብ — ካብ ላዕሊ ቀያይር።',delivery:'ኣየብጽሕን — ኣብ ሰለስተ ዱኳናትና ተበል።'},
...
function botReply(raw, lang) {
  ...
  if (/(friends|invite|referral|ጓደ)/.test(t)) return '🎁 Moka Friends: invite 3 friends → free drink! /friends.html';
...
const HTML_PAGES = { '/': 'index.html', '/index.html': 'index.html', '/login.html': 'login.html', '/register.html': 'register.html', '/admin.html': 'admin.html', '/track.html': 'track.html', '/quiz.html': 'quiz.html', '/story.html': 'story.html', '/friends.html': 'friends.html', '/terms.html': 'terms.html' };
...
if (!IS_VERCEL) {
  app.listen(PORT, () => console.log(`\n   ☕ MOKA HOUSE · ${NODE_ENV}\n   → http://localhost:${PORT}\n   🛡️ Security · 📊 Analytics · 🚫 404 · ✍️ ERMIAS AMARE\n`));
}
export default app;