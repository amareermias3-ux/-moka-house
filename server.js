...
am:{register:'መለያ ለመፍጠር፦ Register ገጽ ላይ ስም፣ ኢሜይል፣ ስልክ እና የይለፍ ቃል ሞላ — ወይም "በGoogle ተመዝገብ"።',login:'በተጠቃሚ ስም ወይም ኢሜይል + የይለፍ ቃል ግባ — ወይም በGoogle።',wallet:'ቴሌ ብር፣ ኤም-ፔሳ፣ PayPal፣ ካርድ፣ ባንክ እና ክሪፕቶ እንቀበላለን።',stamps:'ስታምፕ ካርድ፦ በእያንዳንዱ መጠጥ አንድ ስታምፕ — 7 ገዝተህ 8ኛው ነፃ።',new:'አዲስ ዜና፦ ',langs:'ሳይቱ በ8 ቋንቋዎች ይናገራል — ከላይ ቀኝ መቀየር ትችላለህ።',delivery:'እስካሁን አናደርስም — በሦስቱም ሱቆቻችን ተረብ።'},
...
ti:{register:'ሕሳብ ንምፍጣር፡ ኣብ Register ስም፡ ኢመይል፡ ስልክን ፓስዎርድን መላእ — ወይ ብGoogle።',login:'ብስም ወይ ኢመይል + ፓስዎርድ እቶ፡ ወይ ብGoogle።',wallet:'Telebirr, M-Pesa, PayPal, ካርድ, ባንክን ክሪፕቶን ንቕበል።',stamps:'ካርዲ፡ ንነፍሲ ወከፍ መስተ ሓንቲ ስታምፕ — 7 ግዛእ 8ይ ነጻ።',new:'ሓድሽ ዜና፦ ',langs:'እቲ ሳይት 8 ቋንቋታት ይዛረብ — ካብ ላዕሊ ቀያይር።',delivery:'ኣየብጽሕን — ኣብ ሰለስተ ዱኳናትና ተቐበል።'},
...
function botReply(raw, lang) {
  ...
  if (/(language|translate|ቋንቋ|afaan|luqad|idioma|langue)/.test(t)) return x.langs;
