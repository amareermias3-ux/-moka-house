/* ================================================================
   MOKA HOUSE — v5.2 (Stateless sessions + 8 langs + smart bot + wallet)
================================================================ */
...
<div style="display:flex;gap:1.4rem;flex-wrap:wrap;justify-content:center;align-items:center;padding:1.1rem 1rem 1.5rem;font-family:'Space Mono',monospace;font-size:.66rem;letter-spacing:.1em;color:#93866f;border-top:1px solid rgba(241,230,212,.12);margin-top:2.5rem;text-align:center">
  <span data-i18n="bot_credit">☕ ህ ፕሮጀክት የተሰራው በ</span>&nbsp;<b style="color:#d98e32">Ermias Amare</b>
...
am:{board:'ሜኑው',brew:'ማፍያ ላብ',shops:'ሱቆች',club:'ስታምፕ ርድ',events:'ግጅች',staff:'ሠተኛ ⚿',tray:'መሸጫ',mast_copy:'ትንሽ-ርቲ ቡና፣ ማክሰ ሁሉ በለኛው ክፍል የተጠበ እና በስት ካውንተሮች ቀኑን ሙሉ የሚ።',cta1:'ሜኑውን ር ↓',cta2:'ኩፒንግ ያዝ',roast:'ዛሬ በባር ላይ →',open_closes:'ክፍት · ይጋል',closed_opens:'ዝግ · ይከታል',closed_day:'ዛሬ ግ ነው',s1_title:'ዛሬ <em>ምን አለ</em>',s1_desc:'ሁሉም በቤት ውስጥ የተዘጋጀ። ወደ መሸጫህ ጨምረህ በምትፈልገው ዘዴ ክል።',add:'+ ጨምር',soldout:'አልቋል',cat_all:'ሁሉም',cat_espresso:'ኤስሬሶ',cat_filter:'ፊልተር',cat_cold:'ቀዝቃዛ',cat_bakes:'ኬኮች',s2_title:'በቤት <em>አዘጋጅ</em>',s2_desc:'የባር ስነ-ህጎቻችን በቀጥታ። ዘዴ ምረ እና ከይመሩ ር አዘጅ',dose:'መጠን',ratio:'ኑ',water:'ውሃ',temp:'የውሃ ሙቀት',grind:'ፍጭት',timer:'ማፍያ ታይመር',start:'ማፍያ ጀምር ▸',s3_title:'ሦስት ክፍሎች፣ <em>አንድ ጥበስ</em>',s3_desc:'ቀጥታ የበር ሁኔታ፣ ከሰቱ።',s4_title:'ሰብ ግዛ፣ <em>ስምንተኛው በእኛ</em>',s4_desc:'በእያንዳንዱ መጠጥ አንድ ስታምፕ — ካርድህ ያስታውስሃል።',p1:'ካርዱ ሲሞላ ማንኛውም መጠን ነፃ መጠጥ',p2:'የእያንዳንዱ አዲስ ጥበስ የመጀመሪያ ዳ ለአባላት',p3:'በቡና ፍሬዎች 10% ቅናሽ፣ ሁልጊዜ',p4:'በአርብ ኩፒንጎች የመቀመጫ ቅድሚያ',collect:'የዛሬን ስታምፕ ሰብስብ',s5_title:'ክፍለ-ጊዜች እና <em>ስነ-ጣም</em>',s5_desc:'መቀመጫዎች ውስን ናቸው — ያዙ።',seats:'መቀመጫዎች ቀርተል',reserve:'መቀመጫ ያዙ',s6_title:'ዜና እና <em>ታሪች</em>',s6_desc:'የምናጠብሰው እና የምንቀዳው — በሠራተኞች የተለጠፈ።',hello_title:'ሰላም በል — <b>መልካም ነገር</b> እንቀዳልሃለን።',news_btn:'ወደ ዝርዝ ተቀቀል',f_visit:'ጎብኝ',f_hours:'ሰዓታት',f_elsewhere:'ሌላም',empty_tray:'መሸጫ ባዶ ነው።',pickup:'መውሰጃ',subtotal:'ንዑስ ድምር',checkout:'ክፍያ ◆',pay_method:'የመክፈያ ዴ ምረጥ',confirm:'ክፍያውን አረጋግጥ',processing:'በሂደት ላይ...',cancel:'ይቅር',success:'ክፍያው ተሳክቷል!',order_no:'ትዕዛዝ',chat_greet:'ሰላም! ☕ ስለ ሜኑ፣ ዋጋ፣ ሰዓት፣ ዝጅት ወይም ማፍያ የፈለግክህን ጠይቅ።',chat_ph:'የፈለግክህን ይይቅ…',bot_menu:'በሜኑ ላይ',bot_price:'ዋጋው',bot_hours:'ክፍት እንሆናለን',bot_loc:'የምንገኝበት',bot_pay:'የምንቀበላቸው',bot_stamp:'ስታምፕ ርድ 7 ግዛ፣ 8ኛው ነፃ።',bot_events:'የሚመጡ ዝግጅቶች',bot_brew:'የማፍያ መመሪያ',bot_langs:'ሳይ የሚናገራቸው',bot_credit:'ይህ ፕሮክት የተሰራው በ',bot_fallback:'ሜኑን፣ ዋጋን፣ ሰዓትን፣ ዝጅቶችን፣ ክፍያዎችን እና ማያን አውቃለሁ — ሞክረኝ!',back_shop:'← ወደ ቁ መለስ',login:'ግባ',register:'ተመዝገብ',logout:'ውጣ'},
...
ti:{board:'ሜኑ',brew:'ላብ ን',shops:'ዱኳናት',club:'ካርዲ',events:'መደባት',staff:'ሰራሕተኛ ⚿',tray:'መሸጢ',mast_copy:'ንእሽቶ ጅለ ን፡ ሰሉስ ጠቡ ብሰለስተ ቦታ መዓልቲ ምሉእ ይስራብ።',cta1:'ሜኑ ርአ ↓',cta2:'ምስትምቓር ሓዝ',roast:'ሎ ኣብ ር →',open_closes:'ክት · ዕ',closed_opens:'ጹው · ክፈት',closed_day:'ሎሚ ዕጹው',s1_title:'ሎሚ <em>እንታይ ኣሎ</em>',s1_desc:'ኩሉ ኣ ውሽ ይዳሎ። ና መሸኻ ወስኽ።',add:'+ ወስኽ',soldout:'ወዲ',cat_all:'ሉ',cat_espresso:'ኤስረሶ',cat_filter:'ፊልተር',cat_cold:'ዝሑል',cat_bakes:'ዳቦ',s2_title:'ኣብ ዛ <em>ዳሎ</em>',s2_desc:'ሕታት ባርና። መገዲ ሓሪኻ ምስ ታይመር ዳሎ።',dose:'መጠን',ratio:'ሬሾ',water:'ማይ',temp:'ሙቐት ማይ',grind:'ጥሕነት',timer:'ታይመር',start:'ጀምር ▸',s3_title:'ሰለስተ ክፍሊ፡ <em>ሓንቲ ጥብሲ</em>',s3_desc:'ኩነታት ብቐጥታ።',s4_title:'ሸውተ ግዛእ፡ <em>8ይ ብናትና</em>',s4_desc:'ንነፍሲ ወከፍ ስቲ ንቲ ታም።',p1:'ካርዲ ምስ መልአ ነጻ ተ',p2:'ቀማይ ቲ ንኣባላት',p3:'ኣብ ቡን 10% ርካሽ',p4:'ቀዳምነት መቐመጢ ዓርቢ',collect:'ስታምፓ ሎሚ',s5_title:'ክፍለ ግዜን <em>ምስትምቓርን</em>',s5_desc:'መቐመጢ ውሱን — ሓዝ።',seats:'መቐመጢ ተሪፉ',reserve:'መቐመጢ ሓዝ',s6_title:'ዜናን <em>ታሪኽን</em>',s6_desc:'እንጠብቆ — ብሰሕተኛት።',hello_title:'ሰላም በል — <b>ጽቕ</b> ስትየካ።',news_btn:'ናብ ዝርዝር ጽምበር',f_visit:'በጽሕ',f_hours:'ሰዓት',f_elsewhere:'ካልእ',empty_tray:'መሸጢኻ ባዕ እዩ።',pickup:'ምውሳድ',subtotal:'ንኡስ ድምር',checkout:'ክፈል ◆',pay_method:'መገዲ ክፍሊት ረ',confirm:'ኣረጋግጽ',processing:'ይስራሕ...',cancel:'ሰር',success:'ክሊት ዓዊቱ!',order_no:'ትእዛዝ',chat_greet:'ሰላም! ☕ ዛዕ ሜኑ ዋ፡ ዓት ሕተት።',chat_ph:'ዝደለኻዮ ሕተት…',bot_menu:'ኣብ ሜኑ',bot_price:'ዋጋ',bot_hours:'ክፉት ኢና',bot_loc:'ትረኽበና',bot_pay:'ንቕበል',bot_stamp:'ካርዲ፡ 7 ግእ 8ይ ጻ',bot_events:'መጽእ መደባት',bot_brew:'መምርሒ ዳሎ',bot_langs:'እቲ ሳይት ዝዛረበን',bot_credit:'እዚ ፕሮጀክት ብ',bot_fallback:'ሜኑ፡ ዋጋ ሰዓት መደባት፡ ክሊት እፈልጥ — ፈትን!',back_shop:'← ናብ ዱኳን',login:'እቶ',register:'ተመዝገብ',logout:'ውጻእ'},
...
/* ---------- 🔐 Stateless signed sessions (Vercel-safe) ---------- */
...
app.get('/api/users', requireLogin, (req, res) => {
  ...
  res.json(db.users.map(u => ({ user: u.user, role: u.role, provider: u.provider || 'password', email: u.email || null, permissions: u.permissions || null, created: u.created, sessions: 0 })));
});
...
if (!IS_VERCEL) {
  app.listen(PORT, () => console.log(`\n   ☕ MOKA HOUSE · ${NODE_ENV}\n   → http://localhost:${PORT}\n   🌍 8 langs · 🤖 smart bot · 🔐 stateless sessions · ✍️ Ermias Amare\n`));
}
export default app;