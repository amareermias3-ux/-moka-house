/* ================================================================
   MOKA HOUSE — v7.1 (Friends referral button on every page)
================================================================ */
...
am:{board:'ሜኑው',brew:'ማፍያ ላብ',shops:'ሱቆች',club:'ስታምፕ ካርድ',events:'ዝግጅቶች',staff:'ሠራተኛ ⚿',tray:'መሸጫ',mast_copy:'ትንሽ-ርቢ ቡና፣ ማክሰ ሁሉ በኋለኛው ክፍል የተጠበሰ እና በሦስት ካውንተሮች ቀኑን ሙሉ የሚቀ።',cta1:'ሜኑውን ር ↓',cta2:'ኩፒንግ ያ',roast:'ዛሬ በባር ላይ →',open_closes:'ክፍት · ይዘጋል',closed_opens:'ዝግ · ይከታል',closed_day:'ዛሬ ግ ነው',s1_title:'ዛሬ <em>ምን አለ</em>',s1_desc:'ሁሉም በቤት ውስጥ የተዘጋጀ። ወደ መሸጫ ጨምረህ በምትፈልገው ዘዴ ክፈል።',add:'+ ጨምር',soldout:'አልቋል',cat_all:'ሁሉም',cat_espresso:'ኤስፕሬሶ',cat_filter:'ፊልተር',cat_cold:'ቀዝዛ',cat_bakes:'ኬኮች',s2_title:'በቤት <em>አዘጋጅ</em>',s2_desc:'የባር ስነ-ህጎቻችን በቀጥ። ዴ ምረጥ እና ከታይመር ጋር አዘጋጅ',dose:'መጠን',ratio:'ሬሾ',water:'ውሃ',temp:'የውሃ ሙቀት',grind:'ፍት',timer:'ማያ ታይመር',start:'ማፍያ ጀምር ▸',s3_title:'ሦስት ክፍች፣ <em>አንድ ጥበስ</em>',s3_desc:'ቀጥታ የበር ሁኔታ፣ ከሰዓቱ።',s4_title:'ሰ ግዛ <em>ስምንተኛው በእኛ</em>',s4_desc:'በእያንዳንዱ መጠጥ አን ስታም — ካርድህ ያስታውስሃል።',p1:'ካርዱ ሲሞላ ማንኛውም መጠን ነፃ መጠጥ',p2:'የእያንዳንዱ አዲስ ጥበስ የመጀመሪያ ቅዳ ለአባላት',p3:'በቡና ፍሬዎች 10% ቅናሽ፣ ሁልጊዜ',p4:'በአርብ ኩፒንጎች የመቀመጫ ቅድሚያ',collect:'የዛሬን ስታምፕ ሰብስብ',s5_title:'ክፍለ-ጊዜች እና <em>ስነ-ጣም</em>',s5_desc:'መቀመጫዎች ውስን ቸው — ያዙ።',seats:'መቀመጫዎች ቀርተዋል',reserve:'መቀመጫ ያዙ',s6_title:'ዜና እና <em>ታሪኮች</em>',s6_desc:'የምናጠሰው እና የምንቀዳው — በሠራተኞች የተለጠ።',hello_title:'ሰላም በል — <b>መልካም ነገር</b> እንቀዳልሃለን።',news_btn:'ወደ ዝርዝር ተቀበል',f_visit:'ጎኝ',f_hours:'ሰዓት',f_elsewhere:'ሌላም',empty_tray:'መሸጫህ ዶ ነው',pickup:'መውሰጃ',subtotal:'ንዑስ ድምር',checkout:'ክፍያ ◆',pay_method:'የመክፈያ ዘዴ ምረጥ',confirm:'ክፍያውን አረጋግጥ',processing:'በሂደት ላይ...',cancel:'ይቅር',success:'ክፍያው ተሳክቷል!',order_no:'ትዕዛዝ',chat_greet:'ሰላም! ☕ ስለ ኑ ዋ፣ ዓት ዝግጅት ወይም ማፍያ የፈለግክህን ጠይቅ።',chat_ph:'የፈለግክህን ጠይቅ…',bot_menu:'በሜኑ ይ',bot_price:'ዋጋው',bot_hours:'ክፍት እንሆናለን',bot_loc:'የምንገኝበት',bot_pay:'የምንቀበላቸው',bot_stamp:'ስታምፕ ካርድ፦ 7 ግ፣ 8ው ነ።',bot_events:'የሚመጡ ዝግጅቶች',bot_brew:'የማፍያ መመሪያ',bot_langs:'ሳይ የሚናገራቸው',bot_credit:'የተሰራው በ',bot_fallback:'ሜኑን፣ ዋጋን፣ ሰዓትን፣ ዝግጅቶችን፣ ክያዎችን እና ማፍያን አውቃለሁ — ሞክረኝ!',back_shop:'← ወደ ሱቅ ተመለስ',login:'ግባ',register:'ተመዝገብ',logout:'ውጣ',track_order:'ትዕዛዝ ከታተል',my_orders:'የእኔ ትዕዛዞች'},
...
ti:{board:'ሜኑ',brew:'ላብ ን',shops:'ዱኳናት',club:'ካርዲ',events:'መደባት',staff:'ሰራሕተኛ ⚿',tray:'መሸጢ',mast_copy:'ንእሽቶ ጅምላ ቡን ሰሉስ ጠዩ ብሰለስተ ቦታ መዓልቲ ምሉእ ይስራብ።',cta1:'ሜኑ ርአ ↓',cta2:'ምስትምቓር ሓዝ',roast:'ሎሚ ኣብ ር →',open_closes:'ክፉት · ዕጾ',closed_opens:'ዕጹው · ክፈት',closed_day:'ሎሚ ዕጹው',s1_title:'ሎሚ <em>እንታይ ኣሎ</em>',s1_desc:'ኩሉ ብ ውጢ ይ ናብ መጢኻ ወስኽ።',add:'+ ወስኽ',soldout:'ወዲኡ',cat_all:'ኩሉ',cat_espresso:'ኤስረሶ',cat_filter:'ፊልተር',cat_cold:'ዝሑል',cat_bakes:'ዳቦ',s2_title:'ኣብ ገዛ <em>ዳሎ</em>',s2_desc:'ሕግት ባርና መገዲ ሓኻ ስ ታይመር ዳሎ።',dose:'መጠን',ratio:'ሬሾ',water:'ማይ',temp:'ሙቐት ማይ',grind:'ጥሕነት',timer:'ታይመር',start:'ጀምር ▸',s3_title:'ሰለስተ ክፍሊ፡ <em>ሓንቲ ጥብ</em>',s3_desc:'ኩነታት ብቐጥታ።',s4_title:'ሸውዓተ ግዛእ፡ <em>8ይ ብናትና</em>',s4_desc:'ንነፍሲ ወከፍ መስተ ሓንቲ ስታምፕ።',p1:'ካርዲ ምስ መልአ ነጻ መስተ',p2:'ቀዳማይ ቡን ንኣላት',p3:'ኣብ ቡን 10% ርካሽ',p4:'ቀምነት መቐመጢ ዓርቢ',collect:'ስታምፕ ሎሚ',s5_title:'ክለ ግዜን <em>ምስትምቓርን</em>',s5_desc:'መቐመጢ ውሱን — ሓዝ',seats:'መቐመጢ ተፉ',reserve:'መቐመጢ ሓዝ',s6_title:'ዜናን <em>ታሪኽን</em>',s6_desc:'እንጠብቖ — ብሰራሕተኛታት',hello_title:'ላም በል — <b>ጽቡቕ</b> ከስትየካ።',news_btn:'ናብ ዝርዝር ጽምበር',f_visit:'በጽሕ',f_hours:'ሰዓታት',f_elsewhere:'ካልእ',empty_tray:'መሸጢኻ ዶ እዩ።',pickup:'ምውሳድ',subtotal:'ንኡስ ድምር',checkout:'ክፈል ◆',pay_method:'መገዲ ክፍሊት ረ',confirm:'ረጋግጽ',processing:'ይስራሕ...',cancel:'ሰርዝ',success:'ክፍሊት ዓዊ!',order_no:'ትእዛዝ',chat_greet:'ሰላም! ☕ ብዛዕባ ሜኑ ዋ ሰዓት፡ መደባት ሕተት።',chat_ph:'ዝደለኻዮ ሕተት…',bot_menu:'ኣብ ሜኑ',bot_price:'ዋጋኡ',bot_hours:'ክፉታት ኢና',bot_loc:'ትረኽበና',bot_pay:'ንቕበሎም',bot_stamp:'ካርዲ፡ 7 ግዛእ 8ይ ነጻ።',bot_events:'መጺኦም መደባት',bot_brew:'መምርሒ ዳሎ',bot_langs:'እቲ ሳይት ዝዛረበን',bot_credit:'ዝተሰርሐ ብ',bot_fallback:'ሜኑ ጋ ሰዓት፡ መደባት፡ ክፍሊት እፈልጥ — ፈትን!',back_shop:'← ናብ ዱን',login:'እቶ',register:'ተመዝገብ',logout:'ውጻእ',track_order:'ትእዛዝ ስዓ',my_orders:'ትእዛዛተይ'},
...
am:{register:'መለያ ለመፍጠር፦ Register ጽ ላይ ስም፣ ኢሜይል፣ ልክ እና የይለፍ ቃል ላ — ወይም "በGoogle ተመዝገብ"።',login:'በተጠሚ ስም ወይም ኢሜይል + የይለፍ ቃል ግባ — ወይም በGoogle።',wallet:'ቴሌ ብር፣ ኤም-ፔሳ PayPal፣ ካርድ፣ ባንክ እና ሪፕቶ እንቀበላለን።',stamps:'ስታምፕ ካርድ፦ በእያንዳንዱ መጠጥ አንድ ስታም — 7 ዝተህ 8ኛው ነፃ።',new:'አዲስ ዜና፦ ',langs:'ሳይቱ በ8 ቋንቋዎች ይናገራል — ከላይ ቀኝ መቀየር ትችላለህ።',delivery:'እስካሁን አናደርስም — በሦስቱም ሱቆችን ተብ።'},
...
ti:{register:'ሕሳ ንምጣር ኣብ Register ስም፡ ኢመይል፡ ልክን ፓስዎርድን መላእ — ወይ ብGoogle።',login:'ብስም ወይ ኢመይል + ፓስዎርድ እቶ፡ ይ ብGoogle',wallet:'Telebirr, M-Pesa, PayPal, ካርድ, ባንክን ክሪፕቶን ንቕበል።',stamps:'ካርዲ፡ ንነፍሲ ወከፍ መስተ ሓንቲ ስታምፕ — 7 ግዛእ 8ይ ነጻ።',new:'ሓድሽ ና፦ ',langs:'እቲ ሳይት 8 ቋንቋታት ይዛረ — ካብ ዕሊ ቀያይር።',delivery:'ኣየጽሕን — ኣብ ሰለስተ ዱኳናትና ተቐበል።'},
...
function botReply(raw, lang) {
  ...
  if (/(hour|open|close|when|time|ሰዓት|ፍት|saacad|horario|horaire)/.test(t)) return `${d.bot_hours}: ${HOURS_TEXT}`;
...
app.get(Object.keys(HTML_PAGES), (req, res, next) => {
  ...
  fs.readFile(file, 'utf8', (err, html) => {
    if (err) return next();
    const injection = `<script>window.__I18N = ${JSON.stringify(I18N)};</script>${TRACK_FLOAT}${SHARE_FLOAT}${FRIENDS_FLOAT}${CREDIT_HTML}`;
...
if (!IS_VERCEL) {
  app.listen(PORT, () => console.log(`\n   ☕ MOKA HOUSE · ${NODE_ENV}\n   → http://localhost:${PORT}\n   🛡️ Security AI · 🎁 Friends · ️ ERMIAS AMARE\n`));
}
export default app;