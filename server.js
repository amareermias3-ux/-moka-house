...
am:{board:'ሜኑው',brew:'ማፍያ ላብ',shops:'ሱቆች',club:'ስታምፕ ካርድ',events:'ዝግጅቶች',staff:'ሠራተኛ ⚿',tray:'መሸጫ',mast_copy:'ትንሽ-ርቢ ቡና፣ ማክሰ ሁሉ በለኛው ፍል የተበሰ እና በሦስት ካውንተሮች ቀኑን ሙሉ የሚቀ።',cta1:'ሜኑውን ር ↓',cta2:'ኩፒንግ ያዝ',roast:'ዛሬ በባር ላይ →',open_closes:'ክፍት · ይዘጋል',closed_opens:'ዝግ · ይከፈታል',closed_day:'ዛሬ ግ ነው',s1_title:'ዛሬ <em>ምን አለ</em>',s1_desc:'ሁሉም በቤት ውስጥ የተዘጋጀ። ወደ መሸጫ ጨምረህ በምትፈልገው ዘዴ ክል።',add:'+ ጨምር',soldout:'አልቋል',cat_all:'ሁሉም',cat_espresso:'ኤስፕሬሶ',cat_filter:'ፊልተር',cat_cold:'ቀዝቃዛ',cat_bakes:'ኬኮች',s2_title:'በቤት <em>አዘጋጅ</em>',s2_desc:'የባር ስነ-ህጎቻችን በቀጥ። ዘ ምረ እና ከይመር ጋር አዘጋጅ',dose:'መጠን',ratio:'ሬሾ',water:'ውሃ',temp:'የውሃ ሙቀት',grind:'ፍጭት',timer:'ማፍያ ታይመር',start:'ማፍያ ጀምር ▸',s3_title:'ሦስት ክፍሎች፣ <em>አንድ ጥበስ</em>',s3_desc:'ቀጥታ የበር ሁኔታ፣ ከሰዓ።',s4_title:'ሰብ ግዛ፣ <em>ስምንተኛው በእኛ</em>',s4_desc:'በእያንዳንዱ መጠጥ አንድ ስታምፕ — ካርድህ ያስታውስሃል።',p1:'ካርዱ ሲሞላ ማንኛውም መጠን ነፃ መጥ',p2:'የእያንዳንዱ አዲስ ጥበስ የመጀመሪያ ቅዳ አባት',p3:'በቡና ፍሬዎች 10% ቅናሽ፣ ልጊዜ',p4:'በአርብ ኩፒንጎች የመቀመ ቅድያ',collect:'የዛሬን ስምፕ ሰብስብ',s5_title:'ክፍለ-ጊዜች እና <em>ስነ-ጣም</em>',s5_desc:'መቀመጫዎች ውስን ናቸው — ያዙ',seats:'መቀመጫዎች ቀርተል',reserve:'መቀመጫ ያዙ',s6_title:'ዜና እና <em>ታሪኮች</em>',s6_desc:'የምናጠሰው እና የምንቀዳው — በሠራተኞች የተለጠ።',hello_title:'ሰላም በል — <b>መልካም ነገር</b> እንቀዳልሃለን።',news_btn:'ወደ ርዝር ቀላል',f_visit:'ጎብ',f_hours:'ዓት',f_elsewhere:'ሌላም',empty_tray:'መሸጫ ባዶ ነው።',pickup:'መውሰጃ',subtotal:'ንዑስ ድምር',checkout:'ክፍያ ◆',pay_method:'የመክያ ዘ ምረ',confirm:'ፍያውን አረጋግጥ',processing:'በሂደት ይ...',cancel:'ይቅር',success:'ክፍያው ተሳክቷል!',order_no:'ትዕዛዝ',chat_greet:'ሰላም! ☕ ስለ ሜኑ፣ ዋጋ ሰዓት፣ ዝግጅት ይም ማፍያ የፈለግክህን ጠይቅ።',chat_ph:'የፈለግክህን ጠይቅ…',bot_menu:'በሜኑ ይ',bot_price:'ዋጋው',bot_hours:'ክፍት እንሆናለን',bot_loc:'የምንገኝበት',bot_pay:'የምንቀበላቸው',bot_stamp:'ስታምፕ ካርድ፦ 7 ግ፣ 8ኛው ነፃ።',bot_events:'የሚመጡ ዝግጅቶች',bot_brew:'የማፍያ መመሪያ',bot_langs:'ሳይ የሚናገራቸው',bot_credit:'የተሰራው በ',bot_fallback:'ሜኑን፣ ዋጋን፣ ሰዓትን፣ ዝግጅቶችን፣ ክያዎችን እና ማፍያን አውቃለሁ — ክረኝ!',back_shop:'← ወደ ቅ ተመለስ',login:'ግባ',register:'ተመዝገብ',logout:'ውጣ',track_order:'ትዕዛዝ ከታተል',my_orders:'የእኔ ትዕዛዞች'},
...
ti:{board:'ሜኑ',brew:'ላብ ን',shops:'ዱናት',club:'ርዲ',events:'መደባት',staff:'ሰራሕተኛ ⚿',tray:'መሸጢ',mast_copy:'ንእሽቶ ጅምላ ቡን ሉስ ቢቡ ብሰለስተ ቦታ መልቲ ሉእ ይስራብ።',cta1:'ሜኑ አ ↓',cta2:'ምስትምቓር ሓዝ',roast:'ሎሚ ኣብ ር →',open_closes:'ክፉት · ዕጹው',closed_opens:'ዕጹው · ክፈት',closed_day:'ሎሚ ዕጹው',s1_title:'ሎሚ <em>እንታይ ኣሎ</em>',s1_desc:'ኩሉ ኣብ ውጢ ይዳሎ ናብ መሸጢኻ ወስኽ።',add:'+ ወስኽ',soldout:'ወዲኡ',cat_all:'ኩሉ',cat_espresso:'ኤስፕሬ',cat_filter:'ልተር',cat_cold:'ዝሑል',cat_bakes:'ዳቦ',s2_title:'ኣብ ገዛ <em>ዳሎ</em>',s2_desc:'ሕግት ባርና። መገዲ ሓኻ ስ ታይመር ዳሎ።',dose:'መጠን',ratio:'ሬሾ',water:'ማይ',temp:'ሙቐት ማይ',grind:'ጥነት',timer:'ይመር',start:'ምር ▸',s3_title:'ሰለስተ ክፍሊ፡ <em>ሓንቲ ጥሲ</em>',s3_desc:'ኩነታት ብቐጥታ።',s4_title:'ሸውዓተ ግዛእ፡ <em>8ይ ብናትና</em>',s4_desc:'ንነፍሲ ወከፍ መስተ ሓንቲ ስታምፕ።',p1:'ካርዲ ምስ መልአ ነጻ መስተ',p2:'ቀዳማይ ቡን ንኣላት',p3:'ኣብ ን 10% ርካሽ',p4:'ቀዳምነት መቐመጢ ዓርቢ',collect:'ስታምፕ ሎሚ',s5_title:'ክፍለ ግዜን <em>ምስትምቓርን</em>',s5_desc:'መቐመጢ ውሱን — ሓዝ።',seats:'መቐመጢ ተሪፉ',reserve:'መቐመጢ ሓዝ',s6_title:'ዜናን <em>ታሪኽን</em>',s6_desc:'እንጠብቖ — ብሰራሕተኛታት።',hello_title:'ሰላም በል — <b>ጽቡቕ</b> ከስትየካ',news_btn:'ናብ ዝርዝር ጽምበር',f_visit:'በጽሕ',f_hours:'ሰዓት',f_elsewhere:'ካልእ',empty_tray:'መሸጢኻ ዶ እዩ።',pickup:'ምውሳድ',subtotal:'ንኡስ ድምር',checkout:'ክፈል ◆',pay_method:'መገዲ ክፍሊት ረ',confirm:'ኣረጋግጽ',processing:'ይስራሕ...',cancel:'ሰርዝ',success:'ክፍሊት ዓዊ!',order_no:'ትእዛዝ',chat_greet:'ሰላም! ☕ ብዛዕባ ሜኑ ዋ፣ ዓት መደት ሕተት።',chat_ph:'ዝደለኻዮ ሕተት…',bot_menu:'ኣብ ሜኑ',bot_price:'ዋጋኡ',bot_hours:'ክፉታት ኢና',bot_loc:'ትረኽበና',bot_pay:'ንቕበሎም',bot_stamp:'ካርዲ፡ 7 ግእ 8ይ ነጻ',bot_events:'መጺኦም መደባት',bot_brew:'መምርሒ ዳሎ',bot_langs:'እቲ ሳይት ዝዛረበን',bot_credit:'ዝተሰርሐ ብ',bot_fallback:'ሜኑ ዋ፣ ዓት፣ መደባት፣ ክፍሊት እፈልጥ — ፈትን!',back_shop:'← ናብ ኳን',login:'እቶ',register:'ተመዝገብ',logout:'ውጻእ',track_order:'ትእዛዝ ስዓ',my_orders:'ትእዛዛተይ'},
