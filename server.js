/* ================================================================
   MOKA HOUSE — v7.2 (Visitor Analytics)
================================================================ */
...
am:{board:'ሜኑው',brew:'ማፍያ ላብ',shops:'ሱቆች',club:'ስታምፕ ካርድ',events:'ዝግጅቶች',staff:'ሠራተኛ ⚿',tray:'መሸጫ',mast_copy:'ትንሽ-ርቢ ቡና፣ ማክሰኞ ሁሉ በኋለኛው ክፍል የተጠበ እና በሦስት ካውንተሮች ቀኑን ሙሉ የሚቀፍ።',cta1:'ሜኑውን ር ↓',cta2:'ኩፒንግ ያዝ',roast:'ዛሬ በባር ላይ →',open_closes:'ክፍት · ይዘል',closed_opens:'ዝግ · ይከታል',closed_day:'ዛሬ ግ ነው',s1_title:'ዛሬ <em>ምን አለ</em>',s1_desc:'ሁሉም በቤት ውስጥ የተዘጋጀ። ወደ መሸጫ ጨምህ በምትፈልገው ዘዴ ክል።',add:'+ ጨምር',soldout:'አልቋል',cat_all:'ሁሉም',cat_espresso:'ኤስፕሬሶ',cat_filter:'ፊልተር',cat_cold:'ቀዝቃዛ',cat_bakes:'ኬኮች',s2_title:'በቤት <em>አዘጋጅ</em>',s2_desc:'የባር ስነ-ህጎቻችን በቀጥታ። ዘ ምረ እና ከይመር ጋር አዘጋጅ',dose:'መጠን',ratio:'ሬሾ',water:'ውሃ',temp:'የውሃ ሙቀት',grind:'ፍት',timer:'ማፍያ ታይመር',start:'ማፍያ ጀምር ▸',s3_title:'ሦስት ክፍች፣ <em>አንድ ጥበስ</em>',s3_desc:'ቀጥታ የበር ሁኔታ፣ ከሰዓ።',s4_title:'ሰብ ዛ <em>ስምንተኛው በእኛ</em>',s4_desc:'በእያንዳንዱ መጠጥ አንድ ስምፕ — ካርድህ ስታውስሃል።',p1:'ካርዱ ሲላ ንኛውም መጠን ነፃ መጠጥ',p2:'የእያንዳንዱ አዲስ ጥበስ የመጀመሪያ ቅ ለአባት',p3:'በቡና ፍሬዎች 10% ቅናሽ፣ ሁልዜ',p4:'በአርብ ኩፒንጎች የመቀመጫ ቅድሚያ',collect:'የዛሬን ስምፕ ብስብ',s5_title:'ክፍለ-ጊዜች እና <em>ስነ-ጣም</em>',s5_desc:'መቀመጫዎች ውስን ናቸው — ያዙ',seats:'መቀመጫዎች ቀርተዋል',reserve:'መቀመጫ ያዙ',s6_title:'ዜና እና <em>ታሪኮች</em>',s6_desc:'የምናጠሰው እና የምንቀዳው — በሠራተኞች የተለጠ።',hello_title:'ሰላም በል — <b>መልካም ነገር</b> እንቀዳልሃለን።',news_btn:'ወደ ርዝር ተበል',f_visit:'ብ',f_hours:'ዓት',f_elsewhere:'ሌላም',empty_tray:'መሸጫህ ዶ ነው።',pickup:'መውሰጃ',subtotal:'ንዑስ ድምር',checkout:'ክፍያ ◆',pay_method:'የመክፈያ ዘዴ ምረጥ',confirm:'ክፍያውን አረጋግጥ',processing:'በሂደት ይ...',cancel:'ይቅር',success:'ክፍያው ተሳክቷል!',order_no:'ትዕዛዝ',chat_greet:'ሰላም! ☕ ስለ ሜኑ፣ ዋጋ ሰዓት፣ ዝግጅት ወይም ማፍያ የፈለክህን ይቅ።',chat_ph:'የፈለግክህን ጠይቅ…',bot_menu:'በሜኑ ይ',bot_price:'ዋጋው',bot_hours:'ክፍት እንሆናለን',bot_loc:'የምንገኝበት',bot_pay:'የምንቀበላቸው',bot_stamp:'ስታምፕ ካርድ፦ 7 ግ፣ 8ኛው ነፃ።',bot_events:'የሚመጡ ዝግጅቶች',bot_brew:'የማፍያ መመሪያ',bot_langs:'ሳይቱ የሚናገራቸው',bot_credit:'የተሰራው በ',bot_fallback:'ሜኑን፣ ዋን፣ ሰዓትን፣ ዝግጅቶችን፣ ክፍያዎችን እና ማፍያን አውቃለሁ — ሞክረኝ!',back_shop:'← ወደ ሱቅ ተመለስ',login:'ግባ',register:'ተመዝገብ',logout:'ውጣ',track_order:'ትዕዛዝ ከታተል',my_orders:'የእኔ ትዛዞች'},
...
ti:{board:'ሜኑ',brew:'ላብ ን',shops:'ኳናት',club:'ካርዲ',events:'መደባት',staff:'ሰራሕተኛ ⚿',tray:'መሸጢ',mast_copy:'ንእሽቶ ጅምላ ቡን ሰሉስ ጠዩ ሰለስተ ቦታ መዓልቲ ምሉእ ይስራብ።',cta1:'ሜኑ ርአ ↓',cta2:'ምስትምቓር ሓዝ',roast:'ሎሚ ኣብ ር →',open_closes:'ክፉት · ዕጾ',closed_opens:'ዕጹው · ክፈት',closed_day:'ሎሚ ዕጹው',s1_title:'ሎሚ <em>እንታይ ኣሎ</em>',s1_desc:'ኩሉ ኣብ ውሽጢ ሎ ና መሸጢኻ ወስኽ።',add:'+ ወስኽ',soldout:'ወዲኡ',cat_all:'ኩሉ',cat_espresso:'ኤስፕሬሶ',cat_filter:'ፊልተር',cat_cold:'ዝሑል',cat_bakes:'ዳቦ',s2_title:'ኣብ ገዛ <em>ዳሎ</em>',s2_desc:'ሕግት ባርና። መገዲ ሓኻ ስ ታይመር ዳሎ',dose:'መጠን',ratio:'ሬሾ',water:'ማይ',temp:'ሙቐት ማይ',grind:'ጥነት',timer:'ይመር',start:'ምር ▸',s3_title:'ሰለስተ ክፍ፡ <em>ንቲ ብሲ</em>',s3_desc:'ኩነታት ቐጥታ።',s4_title:'ሸውዓተ ግዛእ፡ <em>8ይ ብናትና</em>',s4_desc:'ንነፍ ወከ መስተ ንቲ ታም።',p1:'ካርዲ ምስ መልአ ነጻ መስተ',p2:'ቀዳማይ ቡን ንኣላት',p3:'ኣብ ን 10% ርካሽ',p4:'ቀዳምነት መቐመጢ ዓርቢ',collect:'ስታምፕ ሎሚ',s5_title:'ክፍለ ግዜን <em>ምስትምቓርን</em>',s5_desc:'መቐመጢ ውሱን — ሓዝ።',seats:'መቐመጢ ተሪፉ',reserve:'መቐመጢ ሓዝ',s6_title:'ዜናን <em>ታሪኽን</em>',s6_desc:'እንጠብቖ — ብሰራሕተኛታት።',hello_title:'ሰላም በል — <b>ጽቡቕ</b> ከስትየካ።',news_btn:'ናብ ዝርዝር ምበር',f_visit:'በጽሕ',f_hours:'ሰዓታት',f_elsewhere:'ካልእ',empty_tray:'መሸጢኻ ዶ እዩ።',pickup:'ምውሳድ',subtotal:'ንኡስ ድምር',checkout:'ክፈል ◆',pay_method:'መገዲ ክፍሊት ረ',confirm:'ረጋግጽ',processing:'ይስራሕ...',cancel:'ሰርዝ',success:'ክፍሊት ዓዊቱ!',order_no:'ትእዛዝ',chat_greet:'ሰላም! ☕ ብዛዕባ ሜኑ ዋ፡ ዓት መደት ሕተት።',chat_ph:'ዝደለኻዮ ሕተት…',bot_menu:'ኣብ ሜኑ',bot_price:'ዋጋኡ',bot_hours:'ክፉታት ኢና',bot_loc:'ትረኽበና',bot_pay:'ንቕበሎም',bot_stamp:'ካርዲ፡ 7 ዛእ 8ይ ነጻ።',bot_events:'መጺኦም መደባት',bot_brew:'መምርሒ ዳ',bot_langs:'እቲ ሳይት ዝዛረበን',bot_credit:'ዝተሰርሐ ብ',bot_fallback:'ሜኑ ጋ ሰዓት፡ መደባት፡ ክፍሊት እፈልጥ — ፈትን!',back_shop:'← ናብ ኳን',login:'እቶ',register:'ተመዝገብ',logout:'ውጻእ',track_order:'ትእዛዝ ስብ',my_orders:'ትእዛዛተይ'},
...
const SEED_MENU = [
  ...
  { id: 'jeb', cat: 'Filter', name: 'Buna · Jebena', price: 4.50, desc: 'Traditional ceremony brew, served with a popcorn side.', seed: 'jebena-buna', tags: ['signature'], available: true },
  ...
  { id: 'imac', cat: 'Cold', name: 'Iced Macchiato', price: 4.00, desc: 'Layered espresso over cold milk and ice.', seed: 'iced-macchiato', tags: ['new'], available: true },
  ...
  { id: 'sam', cat: 'Bakes', name: 'Sambusa', price: 2.50, desc: 'Crisp lentil-filled pastry, baked not fried.', seed: 'sambusa', tags: [], available: true },
  { id: 'che', cat: 'Bakes', name: 'Chechebsa', price: 3.80, desc: 'Flaky mitmita-kissed flatbread with butter.', seed: 'chechebsa', tags: [], available: true },
  { id: 'tef', cat: 'Bakes', name: 'Teff Muffin', price: 3.50, desc: 'Gluten-free teff & banana muffin.', seed: 'teff-muffin', tags: ['gf'], available: true },
...
am:{register:'መለያ ለመፍጠር፦ Register ጽ ላይ ስም፣ ኢሜይል፣ ልክ እና የይለፍ ቃል ላ — ወይም "በGoogle ተመዝገ"።',login:'በተጠሚ ስም ወይም ኢሜይል + የይለፍ ቃል ግባ — ወይም በGoogle።',wallet:'ቴሌ ብር፣ ኤም-ፔሳ PayPal፣ ካርድ፣ ባንክ እና ክሪፕ እንቀበላለን።',stamps:'ስታምፕ ካርድ፦ በእያንዳንዱ መጠጥ አንድ ስታም — 7 ዝተህ 8ኛው ነፃ።',new:'አዲስ ዜና ',langs:'ሳይ በ8 ቋንቋዎች ይናገራል — ከላይ ቀኝ መቀየር ትችላለህ።',delivery:'እስካሁን አናደርስም — በሦስቱም ሱቆችን ተከብ።'},
...
ti:{register:'ሕሳ ንምፍጣር፡ ኣ Register ስም፡ ኢመይል፡ ልክን ስዎርድን መላእ — ወይ ብGoogle።',login:'ብስም ወይ ኢመይል + ፓስዎርድ እቶ፡ ወይ ብGoogle።',wallet:'Telebirr, M-Pesa, PayPal, ካርድ, ባንክን ክሪቶን ንቕበል።',stamps:'ካርዲ፡ ነፍ ወከ መስተ ንቲ ስታም — 7 ግዛእ 8ይ ነጻ።',new:'ሓድሽ ዜና፦ ',langs:'እቲ ሳይት 8 ቋንቋታት ይዛረብ — ካብ ላሊ ቀያይር።',delivery:'ኣየብጽሕን — ኣብ ሰለስተ ዱኳናትና ተበል።'},
...
function botReply(raw, lang) {
  ...
  if (/(login|log in|signin|sign in|ግ|እቶ|soo gal|entrer)/.test(t)) return x.login;
  ...
  if (/(track|order status|ተከተል|raadi)/.test(t)) return `${d.track_order}: /track.html`;
...
/* ===== injected floats + analytics beacon (every page) ===== */
const CREDIT_HTML = `
...
const HTML_PAGES = { '/': 'index.html', '/index.html': 'index.html', '/login.html': 'login.html', '/register.html': 'register.html', '/admin.html': 'admin.html', '/track.html': 'track.html', '/quiz.html': 'quiz.html', '/story.html': 'story.html', '/friends.html': 'friends.html' };
app.get(Object.keys(HTML_PAGES), (req, res, next) => {
  const file = path.join(__dirname, 'public', HTML_PAGES[req.path]);
  fs.readFile(file, 'utf8', (err, html) => {
    if (err) return next();
    const injection = `<script>window.__I18N = ${JSON.stringify(I18N)};</script>${ANALYTICS_BEACON}${TRACK_FLOAT}${SHARE_FLOAT}${FRIENDS_FLOAT}${CREDIT_HTML}`;
...
if (!IS_VERCEL) {
  app.listen(PORT, () => console.log(`\n   ☕ MOKA HOUSE · ${NODE_ENV}\n   → http://localhost:${PORT}\n   🛡️ Security · 📊 Analytics ·  Friends · ✍️ ERMIAS AMARE\n`));
}
export default app;