/* ================================================================
   MOKA HOUSE / ERSCOMAS — v7.3 (Leaderboard + loyalty points)
================================================================ */
...
am:{board:'ሜኑው',brew:'ማፍያ ላብ',shops:'ሱቆች',club:'ስታምፕ ካርድ',events:'ዝግጅቶች',staff:'ሠራተኛ ⚿',tray:'መሸጫ',mast_copy:'ትንሽ-ርብ ቡና፣ ማክሰ ሁሉ በኋለኛው ክፍል የተጠበሰ እና በሦስት ካውንተሮች ቀኑን ሙሉ የሚቀ።',cta1:'ሜኑውን ርአ ↓',cta2:'ኩፒንግ ያዝ',roast:'ዛሬ በባር ላይ →',open_closes:'ክፍት · ይዘጋል',closed_opens:'ዝግ · ይከታል',closed_day:'ዛሬ ግ ነው',s1_title:'ዛሬ <em>ምን አለ</em>',s1_desc:'ሁሉም በቤት ውስጥ የተጋጀ። ወደ መሸጫ ጨምህ በምትፈልገው ዘዴ ክል',add:'+ ምር',soldout:'አልቋል',cat_all:'ሁሉም',cat_espresso:'ኤስሬሶ',cat_filter:'ፊልተር',cat_cold:'ቀዝዛ',cat_bakes:'ኬኮች',s2_title:'በቤት <em>አዘጋጅ</em>',s2_desc:'የባር ስነ-ህጎቻችን በቀጥ። ዘዴ ምጥ እና ከታይመር ጋር አዘጋጅ።',dose:'መጠን',ratio:'ሬሾ',water:'ውሃ',temp:'የውሃ ሙቀት',grind:'ፍት',timer:'ማፍያ ታይመር',start:'ማፍያ ጀምር ▸',s3_title:'ሦስት ክፍሎች፣ <em>አንድ ጥበስ</em>',s3_desc:'ቀጥታ የበር ሁኔ፣ ከዓቱ',s4_title:'ሰብ ዛ <em>ስምንተኛው በእኛ</em>',s4_desc:'በእያንዳንዱ መጠጥ አንድ ስታምፕ — ካርድህ ስታውስሃል።',p1:'ካርዱ ሲላ ንኛውም መጠን ነፃ መጠጥ',p2:'የእያንዳንዱ አዲስ ጥበስ የመጀመሪያ ቅዳ ለአባላት',p3:'በቡና ፍሬዎች 10% ቅናሽ፣ ሁልጊዜ',p4:'በአርብ ኩፒንጎች የመቀመጫ ቅድሚያ',collect:'የዛሬን ስታምፕ ሰብስብ',s5_title:'ክፍለ-ጊዜች እና <em>ስነ-ጣም</em>',s5_desc:'መቀመጫዎች ውስን ናቸው — ያዙ።',seats:'መቀመጫዎች ቀርተዋል',reserve:'መቀመጫ ያዙ',s6_title:'ዜና እና <em>ታሪኮች</em>',s6_desc:'የምናጠሰው እና የምንቀዳው — በሠራተኞች የተለጠ።',hello_title:'ሰላም በል — <b>መልካም ነገር</b> እንቀዳልሃለን።',news_btn:'ወደ ዝርዝር ተቀላቀል',f_visit:'ጎብኝ',f_hours:'ሰዓት',f_elsewhere:'ሌላም',empty_tray:'መሸጫህ ባ ነው',pickup:'መውሰጃ',subtotal:'ንዑስ ድምር',checkout:'ክፍያ ◆',pay_method:'የመክፈያ ዘዴ ምጥ',telebirr:'ቴብር',mpesa:'ኤም-ፔሳ',paypal:'PayPal',card:'ካርድ',bank:'ባንክ',crypto:'ክሪቶ',phone:'ስልክ ቁጥር (የራስህ)',email:'ኢሜይል',card_number:'የካርድ ቁጥር',expiry:'ማብቂያ',cvv:'CVV',bank_name:'ባንክህ',account:'የሂሳብ ቁጥር',wallet_address:'የዋሌት አድራሻ',confirm:'ክፍያውን አረጋግጥ',processing:'በሂደት ይ...',cancel:'ይቅር',success:'ክፍያው ተሳቷል!',pending_title:'ክፍያህን በማረጋገጥ ላይ',pending_note:'ክፍያህ ሲደርስ በእጅ እናረጋግጣለን። ዕዛዝህ በወረፋ ስጥ ነው።',order_no:'ትዕዛዝ',chat_greet:'ሰላም! ☕ ስለ ሜኑ ዋ፣ ዓት ዝግጅት ወይም ማፍያ የፈለግክህን ጠይቅ።',chat_ph:'የፈለክህን ይቅ…',bot_menu:'በሜኑ ላይ',bot_price:'ዋጋው',bot_hours:'ክፍት እንሆናለን',bot_loc:'የምንገኝበት',bot_pay:'የምንቀበላቸው',bot_stamp:'ስታምፕ ካርድ፦ 7 ግ፣ 8ው ነ።',bot_events:'የሚመጡ ዝግጅቶች',bot_brew:'የማፍያ መመሪያ',bot_langs:'ሳይቱ የሚናገራው',bot_credit:'የተሰራው በ',bot_fallback:'ሜኑን፣ ዋን፣ ሰዓትን፣ ዝግጅቶችን፣ ክያዎችን እና ማፍያን አውቃለሁ — ሞክረኝ!',back_shop:'← ወደ ሱቅ ተመለስ',login:'ግባ',register:'ተመዝገብ',logout:'ውጣ',track_order:'ትዕዛዝ ተከታተል',my_orders:'የእኔ ትዛዞች'},
...
am:{register:'መለያ ለመፍር፦ Register ጽ ላይ ስም፣ ኢሜይል፣ ልክ እና የይለፍ ቃል ላ — ወይም "በGoogle ተመዝገ"።',login:'በተጠሚ ም ወይም ኢሜይል + የይለፍ ቃል ግባ — ወይም በGoogle።',wallet:'ቴሌ ብር፣ ኤም-ፔ፣ PayPal፣ ካርድ፣ ንክ እና ክሪፕ እንቀበላለን።',stamps:'ስታምፕ ካርድ፦ በእያንዳንዱ መጠጥ አንድ ስታምፕ — 7 ገዝተህ 8ው ነ።',new:'አዲስ ዜና ',langs:'ይቱ በ8 ንቋዎች ይናገራል — ከላይ ቀኝ መቀየር ትችላለህ።',delivery:'እስካሁን አናደርስም — በሦስቱም ሱቆቻችን ተረብ።'},
...
ti:{register:'ሕሳ ንምጣር ኣብ Register ስም፡ ኢመይል፡ ስልክን ፓስዎርድን መላእ — ወይ ብGoogle።',login:'ብስም ወይ ኢመይል + ፓስዎርድ እቶ፡ ወይ ብGoogle',wallet:'Telebirr, M-Pesa, PayPal, ካርድ, ባንክን ክሪቶን ንቕበል።',stamps:'ካርዲ፡ ነፍሲ ወከፍ መስተ ሓንቲ ስታምፕ — 7 ግዛእ 8ይ ነ።',new:'ድሽ ና፦ ',langs:'እቲ ሳይት 8 ቋንቋታት ይዛብ — ካብ ላሊ ቀያይር።',delivery:'ኣየብጽን — ኣ ሰለስተ ኳናትና ቐበል'},
...
function botReply(raw, lang) {
  ...
  if (/(review|star|rating|አስተያየት|ኮከብ)/.test(t)) return '⭐ Leave a review on our homepage — we read every one!';
  if (/(friends|invite|referral|ጓደኛ)/.test(t)) return '🎁 Moka Friends: invite 3 friends → free drink! /friends.html';
  if (/(contact|phone|call|email|ስልክ|ተከስ)/.test(t)) return `${d.bot_credit} ERMIAS AMARE — amareermias@gmail.com · +251 976 021 007 · +251 973 011 231`;
...
app.post('/api/wallet/pay', payLimiter, (req, res) => {
  ...
  setTimeout(() => {
    ...
    /* 🏆 loyalty points: 1 pt per $1 for logged-in customer */
...
if (!IS_VERCEL) {
  app.listen(PORT, () => console.log(`\n   ☕ ERSCOMAS · ${NODE_ENV}\n   → http://localhost:${PORT}\n   🏆 Leaderboard · 🔔 Alerts ·  Receipts · ️ Security · ️ ERMIAS AMARE\n`));
}
export default app;