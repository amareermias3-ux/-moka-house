/* ================================================================
   MOKA HOUSE — v7.0 (Security AI + expanded menu)
================================================================ */
...
am:{board:'ሜኑው',brew:'ማፍያ ላብ',shops:'ሱቆች',club:'ስታምፕ ካርድ',events:'ዝግጅቶች',staff:'ሠራተኛ ⚿',tray:'መሸጫ',mast_copy:'ትንሽ-ርቢ ቡና፣ ማክሰኞ ሁሉ በኋለኛው ክፍል የተጠበ እና በሦስት ካውንተሮች ቀን ሙሉ የሚቀፍ።',cta1:'ሜኑውን ር ↓',cta2:'ኩፒንግ ያዝ',roast:'ዛሬ በባር ላይ →',open_closes:'ክፍት · ይዘጋል',closed_opens:'ዝግ · ይከታል',closed_day:'ዛሬ ግ ነው',s1_title:'ዛሬ <em>ምን አለ</em>',s1_desc:'ሁሉም በቤት ውስጥ የተዘጋጀ። ወደ መሸጫህ ጨምረህ በምትፈልገው ዘዴ ክል።',add:'+ ጨምር',soldout:'አልቋል',cat_all:'ሁሉም',cat_espresso:'ኤስፕሬሶ',cat_filter:'ፊልተር',cat_cold:'ቀዝዛ',cat_bakes:'ኬኮች',s2_title:'በቤት <em>አዘጋጅ</em>',s2_desc:'የባር ስነ-ህጎቻችን በቀጥታ። ዴ ምረጥ እና ከታይመር ጋር አዘጋጅ',dose:'መጠን',ratio:'ሬሾ',water:'ውሃ',temp:'የውሃ ሙቀት',grind:'ፍጭት',timer:'ማፍያ ታይመር',start:'ማፍያ ጀምር ▸',s3_title:'ሦስት ክፍች፣ <em>አንድ ጥበስ</em>',s3_desc:'ቀጥታ የበር ሁኔታ፣ ከሰዓቱ።',s4_title:'ሰብ ግዛ፣ <em>ስምንተኛው በእኛ</em>',s4_desc:'በእያንዳንዱ መጠጥ አን ስታም — ካርድህ ስታውስሃል።',p1:'ካርዱ ሲላ ንኛውም መጠን ነፃ መጠጥ',p2:'የእያንዳንዱ አዲስ በስ የመጀመሪያ ዳ ለአባላት',p3:'በቡና ፍሬዎች 10% ቅናሽ፣ ሁልጊዜ',p4:'በአርብ ኩፒንጎች የመቀመጫ ቅድሚያ',collect:'የዛሬን ስታም ሰብስ',s5_title:'ፍለ-ጊዜዎች እና <em>ስነ-ጣም</em>',s5_desc:'መቀመጫዎች ውስን ናቸው — ያዙ።',seats:'መቀመጫዎች ቀርተዋል',reserve:'መቀመጫ ያዙ',s6_title:'ዜና እና <em>ታሪች</em>',s6_desc:'የምናጠብሰው እና የምንቀዳው — በሠራተኞች የተለጠ።',hello_title:'ሰላም በል — <b>መልካም ነገር</b> እንቀዳልሃለን።',news_btn:'ወደ ዝርዝር ተላቀል',f_visit:'ጎብኝ',f_hours:'ሰዓት',f_elsewhere:'ሌላም',empty_tray:'መሸጫ ባዶ ው።',pickup:'መውሰጃ',subtotal:'ንዑስ ድምር',checkout:'ክፍያ ◆',pay_method:'የመክፈያ ዘዴ ምረጥ',confirm:'ክፍያውን አረጋግጥ',processing:'በሂደት ላይ...',cancel:'ይቅር',success:'ክፍያው ተሳክቷል!',order_no:'ትዕዛዝ',chat_greet:'ሰላም! ☕ ስለ ሜኑ፣ ዋጋ፣ ሰዓት፣ ዝግጅት ወይም ማፍያ የፈለግክህን ጠይቅ።',chat_ph:'የፈለግክህን ጠይቅ…',bot_menu:'በሜኑ ይ',bot_price:'ዋጋው',bot_hours:'ክፍት እንሆናለን',bot_loc:'የምንገኝበት',bot_pay:'የምንቀበላቸው',bot_stamp:'ስታምፕ ካርድ፦ 7 ግ፣ 8ኛው ነፃ።',bot_events:'የሚመጡ ዝግጅቶች',bot_brew:'የማፍያ መመሪያ',bot_langs:'ሳይ የሚናገራው',bot_credit:'የተሰራው በ',bot_fallback:'ሜኑን፣ ዋን፣ ሰዓትን፣ ዝግጅቶችን፣ ክፍያዎችን እና ማፍያን አውቃለሁ — ክረኝ!',back_shop:'← ወ ሱቅ ተመለስ',login:'ግ',register:'ተመዝገብ',logout:'ውጣ',track_order:'ትዕዛዝ ከታተል',my_orders:'የእኔ ትዕዛዞች'},
...
ti:{board:'ሜኑ',brew:'ላብ ን',shops:'ኳናት',club:'ካርዲ',events:'መደባት',staff:'ሰራሕተኛ ⚿',tray:'መሸጢ',mast_copy:'ንእሽቶ ጅምላ ቡን ሰሉስ ጠ ብሰለስተ ቦታ መዓልቲ ምሉእ ይስራብ።',cta1:'ሜኑ ርአ ↓',cta2:'ምስትምቓር ሓዝ',roast:'ሎሚ ኣብ ር →',open_closes:'ክፉት · ዕጾ',closed_opens:'ዕጹው · ክፈት',closed_day:'ሎሚ ዕጹው',s1_title:'ሎሚ <em>እንታይ ኣሎ</em>',s1_desc:'ኩሉ ኣብ ውሽጢ ዳሎ ናብ መሸጢኻ ወስኽ።',add:'+ ወስኽ',soldout:'ወዲኡ',cat_all:'ኩሉ',cat_espresso:'ኤስፕሬሶ',cat_filter:'ፊልተር',cat_cold:'ዝሑል',cat_bakes:'ዳቦ',s2_title:'ኣብ ገዛ <em>ዳሎ</em>',s2_desc:'ሕግታት ባርና። መገዲ ሓኻ ስ ታይመር ዳሎ።',dose:'መጠን',ratio:'ሬሾ',water:'ማይ',temp:'ሙቐት ማይ',grind:'ጥሕነት',timer:'ታይመር',start:'ጀምር ▸',s3_title:'ሰለስተ ክፍሊ፡ <em>ሓንቲ ጥብሲ</em>',s3_desc:'ኩነታት ብቐጥታ።',s4_title:'ሸውዓተ ግዛእ፡ <em>8ይ ብናትና</em>',s4_desc:'ንነፍሲ ወከፍ መስተ ሓንቲ ስታምፕ።',p1:'ካርዲ ምስ መልአ ነጻ መስተ',p2:'ቀዳማይ ቡን ንኣላት',p3:'ኣብ ቡን 10% ርካሽ',p4:'ቀምነት መቐመጢ ዓርቢ',collect:'ስታምፕ ሎሚ',s5_title:'ክፍለ ግዜን <em>ምስትምቓርን</em>',s5_desc:'መቐመጢ ውሱን — ሓዝ',seats:'መቐመጢ ተሪፉ',reserve:'መቐመጢ ሓዝ',s6_title:'ዜናን <em>ታሪኽን</em>',s6_desc:'እንጠብቖ — ብሰራሕተኛታት።',hello_title:'ሰላም በል — <b>ጽቡቕ</b> ከስትየካ።',news_btn:'ናብ ዝርዝር ጽምበር',f_visit:'በጽሕ',f_hours:'ሰዓታት',f_elsewhere:'ካልእ',empty_tray:'መሸጢኻ ዶ እዩ።',pickup:'ምውሳድ',subtotal:'ንኡስ ድምር',checkout:'ክፈል ◆',pay_method:'መገዲ ክፍሊት ረ',confirm:'ረጋግጽ',processing:'ይስራሕ...',cancel:'ሰርዝ',success:'ክፍሊት ዓዊቱ!',order_no:'ትእዛዝ',chat_greet:'ሰላም! ☕ ብዛዕባ ሜኑ ዋ ሰዓት፡ መደባት ሕተት።',chat_ph:'ዝደለኻዮ ሕተት…',bot_menu:'ኣብ ሜኑ',bot_price:'ዋጋኡ',bot_hours:'ክፉታት ኢና',bot_loc:'ትረኽበና',bot_pay:'ንቕበሎም',bot_stamp:'ካርዲ፡ 7 ዛእ 8ይ ነጻ።',bot_events:'መጺኦም መደባት',bot_brew:'መምርሒ ዳሎ',bot_langs:'እቲ ሳይት ዛረበን',bot_credit:'ዝተሰርሐ ብ',bot_fallback:'ሜኑ ጋ ሰዓት፡ መደባት፡ ክፍሊት እፈል — ፈትን!',back_shop:'← ናብ ዱን',login:'እቶ',register:'ተመዝገብ',logout:'ውጻእ',track_order:'ትእዛዝ ስዓ',my_orders:'ትእዛዛተይ'},
...
/* ---------- 🛡️ Security AI (anti-hack + activity monitor) ---------- */
...
am:{register:'መለያ ለመፍጠር፦ Register ጽ ላይ ስም፣ ኢሜይል፣ ልክ እና የይለፍ ቃል ላ — ወይም "በGoogle ተመዝገ"።',login:'በተጠሚ ስም ወይም ኢሜይል + የይለፍ ቃል ባ — ይም በGoogle',wallet:'ሌ ብር፣ ኤም-ፔሳ፣ PayPal፣ ካርድ፣ ባንክ እና ሪቶ እንበላለን።',stamps:'ስታምፕ ካርድ፦ በእያንዳንዱ መጠጥ አንድ ስታም — 7 ገዝተህ 8ው ነ።',new:'አዲስ ዜና ',langs:'ይቱ በ8 ቋንቋዎች ይናገራል — ከላይ ቀኝ መቀየር ትችላለህ።',delivery:'እስካሁን አናደርስም — በሦስቱም ሱቆችን ተረብ።'},
...
ti:{register:'ሕሳ ንምጣር፡ ኣብ Register ም፡ ኢመይል፡ ስልክን ፓስዎርድን መላእ — ወይ ብGoogle።',login:'ብስም ወይ ኢመይል + ፓስዎርድ እቶ፡ ወይ ብGoogle',wallet:'Telebirr, M-Pesa, PayPal, ካርድ, ባንክን ክሪፕቶን ንበል።',stamps:'ካርዲ፡ ንነፍሲ ወከፍ መስተ ሓንቲ ስታምፕ — 7 ግዛእ 8ይ ነ።',new:'ድሽ ዜና፦ ',langs:'እቲ ሳይት 8 ቋንቋታት ይዛረ — ካብ ላዕ ቀያይር',delivery:'ኣየብጽሕን — ኣብ ሰለስተ ዱኳናትና ተበል።'},
...
function botReply(raw, lang) {
  ...
  if (/(hour|open|close|when|time|ሰት|ክት|saacad|horario|horaire)/.test(t)) return `${d.bot_hours}: ${HOURS_TEXT}`;
  ...
  if (/(my orders|my order|history|ታሪክ)/.test(t)) return `${d.my_orders}: login first, then open "My Orders".`;
...
app.use(securityAI); /* 🛡️ anti-hack on every request */
...
if (!IS_VERCEL) {
  app.listen(PORT, () => console.log(`\n   ☕ MOKA HOUSE · ${NODE_ENV}\n   → http://localhost:${PORT}\n   🛡️ Security AI ON · 💰 real payments · ✍️ ERMIAS AMARE\n`));
}
export default app;