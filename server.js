/* ================================================================
   MOKA HOUSE — v5.4 (Portable accounts + Live-knowledge bot)
================================================================ */
...
<div style="display:flex;gap:1.4rem;flex-wrap:wrap;justify-content:center;align-items:center;padding:1.1rem 1rem 1.5rem;font-family:'Space Mono',monospace;font-size:.66rem;letter-spacing:.1em;color:#93866f;border-top:1px solid rgba(241,230,212,.12);margin-top:2.5rem;text-align:center">
  <span data-i18n="bot_credit">☕ ይህ ፕሮጀት የተሰራው በ</span>&nbsp;<b style="color:#d98e32">Ermias Amare</b>
...
am:{board:'ሜኑው',brew:'ማፍያ ብ',shops:'ቆች',club:'ስታምፕ ካርድ',events:'ዝግጅቶች',staff:'ሠራተኛ ⚿',tray:'መሸጫ',mast_copy:'ትንሽ-ርቢ ቡና፣ ማክሰኞ ሁ በኋለኛው ክፍል የተጠበሰ እና በሦስት ካውንተሮች ቀኑን ሙሉ የሚቀፍ።',cta1:'ሜኑውን ር ↓',cta2:'ኩፒንግ ያዝ',roast:'ዛሬ በባር ላይ →',open_closes:'ክፍት · ይጋል',closed_opens:'ዝግ · ይከፈታል',closed_day:'ዛሬ ግ ነው',s1_title:'ዛሬ <em>ምን አለ</em>',s1_desc:'ሁሉም በቤት ውስጥ የተዘጋጀ። ወደ መሸጫህ ጨምረህ በምትፈልው ዘዴ ክፈል።',add:'+ ጨምር',soldout:'አልቋል',cat_all:'ሁሉም',cat_espresso:'ኤስረ',cat_filter:'ፊልተር',cat_cold:'ቀዝቃዛ',cat_bakes:'ኬኮች',s2_title:'በቤት <em>አዘጋ</em>',s2_desc:'የባር ስነ-ህጎቻችን በቀጥታ። ዘዴ ምረጥ እና ከታይመ ጋር አዘጋጅ።',dose:'መጠን',ratio:'ሬሾ',water:'ውሃ',temp:'የውሃ ቀት',grind:'ፍጭት',timer:'ማፍያ ታይመር',start:'ማፍያ ጀምር ▸',s3_title:'ሦስት ክፍሎች፣ <em>አንድ ጥበስ</em>',s3_desc:'ቀጥታ የበር ሁኔታ፣ ከሰቱ።',s4_title:'ሰብ ግዛ፣ <em>ስምንተኛው በእኛ</em>',s4_desc:'በእያንዳንዱ መጠጥ አንድ ስታምፕ — ካርድህ ያስታውስሃል።',p1:'ካርዱ ሲላ ማንኛውም መጠን ነፃ መጠጥ',p2:'የእያንዳንዱ አዲስ ጥበስ የመጀመሪያ ዳ ለአባላት',p3:'በቡና ፍሬች 10% ቅናሽ፣ ሁልጊዜ',p4:'በአርብ ኩፒንጎች የመቀመጫ ቅድሚያ',collect:'የዛሬን ስታም ሰብስብ',s5_title:'ክፍለ-ጊዜች እና <em>ስነ-ጣም</em>',s5_desc:'መቀመጫዎች ውስን ናቸው — ያዙ።',seats:'መቀመጫዎች ቀርተል',reserve:'መቀመጫ ያዙ',s6_title:'ዜና እና <em>ታሪኮች</em>',s6_desc:'የምናጠብሰው እና የምንቀዳው — በሠራተኞች የተለጠ።',hello_title:'ሰላም በል — <b>መልካም ነገር</b> እንቀዳልሃለን።',news_btn:'ወደ ዝርዝ ተቀቀል',f_visit:'ጎብኝ',f_hours:'ሰዓት',f_elsewhere:'ሌላም',empty_tray:'መሸጫህ ባዶ ው።',pickup:'መውሰጃ',subtotal:'ንዑስ ድምር',checkout:'ክፍያ ◆',pay_method:'የመክፈያ ዘዴ ምረጥ',confirm:'ክፍያውን አረጋግጥ',processing:'በሂደት ይ...',cancel:'ይቅር',success:'ክያው ተሳቷል!',order_no:'ትዕዛ',chat_greet:'ሰላም! ☕ ስለ ኑ ዋጋ፣ ሰዓት፣ ዝግጅት ወይም ማያ የፈለግክህን ጠይቅ።',chat_ph:'የፈለግክህን ጠይቅ…',bot_menu:'በሜኑ ላይ',bot_price:'ዋጋው',bot_hours:'ክፍት እንሆናለን',bot_loc:'የምንገኝበት',bot_pay:'የምንቀበላቸው',bot_stamp:'ስታምፕ ርድ፦ 7 ግዛ፣ 8ኛው ነፃ።',bot_events:'የሚመጡ ዝግጅቶች',bot_brew:'የማፍያ መመሪያ',bot_langs:'ሳይ የሚናገራቸው',bot_credit:'ይህ ፕሮክት የተሰራው በ',bot_fallback:'ሜኑን፣ ዋጋን፣ ሰዓትን፣ ዝጅቶችን፣ ክፍያዎችን እና ማፍያን አውቃለሁ — ሞክረኝ!',back_shop:'← ወደ ቁ ተመለስ',login:'ግባ',register:'ተመዝገብ',logout:'ውጣ'},
...
ti:{board:'ሜኑ',brew:'ላብ ን',shops:'ዱናት',club:'ካርዲ',events:'መደባት',staff:'ሰራሕተኛ ⚿',tray:'መሸጢ',mast_copy:'ንእሽቶ ጅምላ ቡን፡ ሰሉስ ጠቡ ብሰለስተ ቦታ መዓልቲ ምሉእ ይስራብ።',cta1:'ሜኑ ርአ ↓',cta2:'ምስትምቓር ሓዝ',roast:'ሎሚ ኣብ ር →',open_closes:'ክፉት · ዕጾ',closed_opens:'ዕጹው · ክፈት',closed_day:'ሎሚ ዕጹው',s1_title:'ሎሚ <em>እንታይ ኣሎ</em>',s1_desc:'ኩሉ ኣብ ውሽጢ ይዳሎ። ናብ መሸጢ ወስኽ',add:'+ ስኽ',soldout:'ወዲኡ',cat_all:'ኩሉ',cat_espresso:'ኤስፕረሶ',cat_filter:'ፊልተር',cat_cold:'ዝሑል',cat_bakes:'ዳቦ',s2_title:'ኣብ ዛ <em>ዳሎ</em>',s2_desc:'ሕታት ባርና። መገዲ ሓሪኻ ምስ ታይመር ዳሎ',dose:'መጠን',ratio:'ሬሾ',water:'ማይ',temp:'ሙቐት ማይ',grind:'ጥሕነት',timer:'ታይመር',start:'ጀምር ▸',s3_title:'ሰለስተ ክፍሊ፡ <em>ሓንቲ ጥብ</em>',s3_desc:'ኩነታት ብቐጥታ።',s4_title:'ሸውዓተ ግዛእ፡ <em>8ይ ብናትና</em>',s4_desc:'ንነፍሲ ወከፍ መስተ ሓንቲ ስታምፕ።',p1:'ካርዲ ምስ መልአ ነጻ መስተ',p2:'ቀዳማይ ቲ ኣባት',p3:'ኣብ ቡን 10% ርካሽ',p4:'ቀምነት መቐመጢ ዓርቢ',collect:'ስታምፕ ሎሚ',s5_title:'ክፍለ ግዜን <em>ምስትምቓርን</em>',s5_desc:'መቐመጢ ውሱን — ሓዝ።',seats:'መቐመጢ ተሪፉ',reserve:'መቐመጢ ሓዝ',s6_title:'ዜናን <em>ታሪኽን</em>',s6_desc:'እንጠብቖ — ብሰሕተኛት።',hello_title:'ሰላም በል — <b>ጽቕ</b> ስትየካ።',news_btn:'ናብ ዝርዝር ጽምበር',f_visit:'በጽሕ',f_hours:'ሰዓታት',f_elsewhere:'ካልእ',empty_tray:'መሸጢኻ ዕል እዩ።',pickup:'ምውሳድ',subtotal:'ንኡስ ድምር',checkout:'ክፈል ◆',pay_method:'መገዲ ክፍሊት ምረጽ',confirm:'ኣረጋግጽ',processing:'ይስራሕ...',cancel:'ሰርዝ',success:'ክፍሊት ዓዊቱ!',order_no:'ትእዛዝ',chat_greet:'ሰላም! ☕ ብዛዕባ ሜኑ፡ ዋ፡ ሰዓት፡ መደባት ሕተት።',chat_ph:'ዝደለዮ ተት…',bot_menu:'ኣብ ሜኑ',bot_price:'ዋጋኡ',bot_hours:'ክፉታት ኢና',bot_loc:'ትረኽበና',bot_pay:'ንቕበሎም',bot_stamp:'ካርዲ፡ 7 ዛእ 8ይ ነጻ።',bot_events:'መጽእ መደባት',bot_brew:'መምርሒ ዳሎ',bot_langs:'እቲ ሳይት ዝዛረበን',bot_credit:'እዚ ፕሮጀክት ብ',bot_fallback:'ሜኑ ዋ፡ ዓት፡ መደባት፡ ክፍሊት እፈልጥ — ፈትን!',back_shop:'← ናብ ዱኳን',login:'እቶ',register:'ተመዝገብ',logout:'ውጻእ'},
...
am:{register:'መለያ ለመፍጠር፦ Register ገጽ ላይ ስም፣ ኢሜይል፣ ስልክ እና የይለፍ ቃል ሞላ — ወይም "በGoogle ተመዝገ"።',login:'በተጠቃሚ ስም ወይም ኢሜይል + የይለፍ ቃል ግባ — ወይም በGoogle።',wallet:'ቴሌ ር፣ ም-ፔሳ፣ PayPal፣ ካርድ፣ ባንክ እና ክሪፕቶ እንቀበላለን።',stamps:'ስታምፕ ካርድ፦ በእያንዳንዱ መጠጥ አንድ ስታምፕ — 7 ገዝተህ 8ኛው ነፃ።',new:'አዲስ ዜና ',langs:'ይቱ በ8 ቋንቋዎች ይናገራል — ከላይ ቀ መቀየር ትችላለህ።',delivery:'እስካሁን አናደርስም — በሦስቱም ሱቆቻችን ተረብ።'},
...
ti:{register:'ሕሳብ ንምፍጣር፡ ኣብ Register ም፡ ኢመይል፡ ስልክን ፓስዎርድን መላእ — ወይ ብGoogle።',login:'ብስም ይ ኢመይል + ፓስዎርድ እቶ፡ ወይ ብGoogle',wallet:'Telebirr, M-Pesa, PayPal, ካርድ, ባንክን ክሪቶን ንበል።',stamps:'ካርዲ፡ ንነፍሲወከፍ መስተ ስታምፕ — 7 ግዛእ 8ይ ነጻ።',new:'ሓድሽ ዜና፦ ',langs:'እቲ ሳይት 8 ቋንቋታት ይዛረ — ካብ ዕሊ ያይር',delivery:'የብሕን — ኣብ ሰለስተ ዱኳናትና ተበል።'},
...
/* 📝 FULL registration + portable account cookie */
...
/* 🔑 Login by username OR email (+ portable fallback) */
...
if (!IS_VERCEL) {
  app.listen(PORT, () => console.log(`\n   ☕ MOKA HOUSE · ${NODE_ENV}\n   → http://localhost:${PORT}\n   🌍 8 langs · 🤖 live bot · 🔐 portable accounts\n`));
}
export default app;