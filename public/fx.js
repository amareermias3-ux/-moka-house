...
(function(){
  ...
  "body.fx-light .fx-stat b{color:#b3691e}body.fx-light .fx-stat span{color:#8a7358}"+
  ...
  "body.fx-light .status-pill .dot{background:#3f7d34}body.fx-light .status-pill.closed .dot{background:#cf5636}"+
  ...
  "body.fx-light .spin-badge circle.c{fill:#fffdf7}body.fx-light .spin-badge text{fill:#b3691e}"+
  ...
  function init(){
    ...
    document.addEventListener('click',function(e){
      ...
      var r=b.getBoundingClientRect();var d=Math.max(r.width,r.height);
